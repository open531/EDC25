...
<table>
  ...
  <tr>
    <td>课程内容简介：</td>
    <td colspan="3">本课程的基础是清华大学电子设计大赛，2012年是第十四届。大赛组委会将提供一定的软硬件平台及文档说明，课程教学组安排相应系列讲座。大赛要求参赛学生自由组队，自主完成系统设计，在比赛平台上用自己制作的电路驱动小车，通过编程实现特定的自动控制功能（本届赛题为机器人棒球赛）。课程涉及到的知识包括电子技术、计算机语言程序设计、单片机或FPGA、传感器、通信、控制等，基本上属于应用层次，无需掌握大量与深入的专业知识。通过本课程学习，可训练综合运用电子和计算机技术的能力，为后续相关课程的学习奠定基础。</td>
  <tr>
  ...
  <tr>
    <td>进度安排：</td>
    <td colspan="3">第一阶段：讲座（18学时），从下列八讲中选择六讲，具体时间和次序届时在网站上公布。专题一：概述及系统功能要求；专题二：电子制作、控制驱动、MCU系统设计；专题三：传感器原理与应用；专题四：PCB设计与制作；专题五：FPGA及其应用；专题六：DSP及其应用；专题七：Labview及其应用；专题八：最优化概论与经典控制算法介绍。第二阶段：实践（设计、制作、辅导）（60学时）。第三阶段：竞赛（预赛、决赛），总结答辩及写报告（18学时）。</td>
  </tr>
  <tr>
    <td>考核方式：</td>
    <td>以赛代考，达到基本要求给予通过；完成初赛进入决赛者，根据决赛成绩给予优秀、良好或百分制分数；决赛优胜者另外还给予奖励。</td>
    <td>教材及参考书：</td>
    <td>《电子线路基础》，高文焕、李冬梅；《模拟电子技术》，华成英；《数字电子技术》，阎石；《EDA技术实用教程》，潘松；《电子系统设计与实践》，贾立新；《电子设计自动化技术及应用》，李明方</td>
  </tr>
  <tr>
    <td>主教材：</td>
    <td colspan="3"></td>
  ...
  <tr>
    <td>合开教师：</td>
    <td>杨耕, 韦思健, 卓晴, 曹丽, 阎捷, 任艳频, 高文焕, 杨兴华, 杨帆, 罗嵘</td>
    <td>选课指导：</td>
    <td>无学科专业限制，具有电子技术基础与计算机编程经验者优先。欢迎现在大三、大二上学生踊跃选课，也欢迎对电设非常感兴趣的学生参加。</td>
  </tr>
  <tr>
    <td>先修要求：</td>
    <td></td>
  ...
  <tr>
    <td>教学日历：</td>
    <td colspan="3"><a href="http://zhjwxk.cic.tsinghua.edu.cn/kc.kc_lrktxx_jxrlb.do?cm=jxrlIndex&kch=01550013&version=1">查看教学日历</a></td>
  </tr>
</table>
