...
#define osCMSIS_FreeRTOS                                                       \
  RTOS_ID_n ///< RTOS identification and version (main[31:16].sub[15:0])
...
#define osFeature_Signals                                                      \
  24U ///< maximum number of Signal Flags available per thread
...
#define osThreadDef(name, priority, instances, stacksz)                        \
  static uint64_t                                                              \
      os_thread_stack##name[(stacksz) ? (((stacksz + 7) / 8)) : 1];            \
...
#define osMutexDef(name)                                                       \
  ...
  const osMutexDef_t os_mutex_def_##name = {                                   \
      NULL, osMutexRecursive | osMutexPrioInherit, (&os_mutex_cb_##name),      \
