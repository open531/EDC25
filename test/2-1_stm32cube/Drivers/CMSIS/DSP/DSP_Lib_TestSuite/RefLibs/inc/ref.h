...
float32_t ref_pid_f32(arm_pid_instance_f32 *S, float32_t in);

q31_t ref_pid_q31(arm_pid_instance_q31 *S, q31_t in);

q15_t ref_pid_q15(arm_pid_instance_q15 *S, q15_t in);
 ...
 * Filtering Functions
 */
void ref_biquad_cascade_df2T_f32(const arm_biquad_cascade_df2T_instance_f32 *S,
...
void ref_biquad_cascade_df2T_f64(const arm_biquad_cascade_df2T_instance_f64 *S,
                                 float64_t *pSrc, float64_t *pDst,
                                 uint32_t blockSize);

void ref_biquad_cascade_df1_f32(const arm_biquad_casd_df1_inst_f32 *S,
                                float32_t *pSrc, float32_t *pDst,
                                uint32_t blockSize);
...
void ref_biquad_cascade_df1_q31(const arm_biquad_casd_df1_inst_q31 *S,
                                q31_t *pSrc, q31_t *pDst, uint32_t blockSize);

void ref_biquad_cascade_df1_fast_q31(const arm_biquad_casd_df1_inst_q31 *S,
                                     q31_t *pSrc, q31_t *pDst,
                                     uint32_t blockSize);

void ref_biquad_cascade_df1_fast_q15(const arm_biquad_casd_df1_inst_q15 *S,
                                     q15_t *pSrc, q15_t *pDst,
                                     uint32_t blockSize);

void ref_biquad_cascade_df1_q15(const arm_biquad_casd_df1_inst_q15 *S,
...
arm_status ref_conv_partial_f32(float32_t *pSrcA, uint32_t srcALen,
...
arm_status ref_conv_partial_q31(q31_t *pSrcA, uint32_t srcALen, q31_t *pSrcB,
                                uint32_t srcBLen, q31_t *pDst,
                                uint32_t firstIndex, uint32_t numPoints);

arm_status ref_conv_partial_fast_q31(q31_t *pSrcA, uint32_t srcALen,
...
arm_status ref_conv_partial_q15(q15_t *pSrcA, uint32_t srcALen, q15_t *pSrcB,
                                uint32_t srcBLen, q15_t *pDst,
                                uint32_t firstIndex, uint32_t numPoints);
...
arm_status ref_conv_partial_fast_q15(q15_t *pSrcA, uint32_t srcALen,
                                     q15_t *pSrcB, uint32_t srcBLen,
                                     q15_t *pDst, uint32_t firstIndex,
                                     uint32_t numPoints);

arm_status ref_conv_partial_fast_opt_q15(q15_t *pSrcA, uint32_t srcALen,
                                         q15_t *pSrcB, uint32_t srcBLen,
                                         q15_t *pDst, uint32_t firstIndex,
...
arm_status ref_conv_partial_q7(q7_t *pSrcA, uint32_t srcALen, q7_t *pSrcB,
...
void ref_fir_f32(const arm_fir_instance_f32 *S, float32_t *pSrc,
                 float32_t *pDst, uint32_t blockSize);

void ref_fir_q31(const arm_fir_instance_q31 *S, q31_t *pSrc, q31_t *pDst,
                 uint32_t blockSize);

void ref_fir_fast_q31(const arm_fir_instance_q31 *S, q31_t *pSrc, q31_t *pDst,
                      uint32_t blockSize);

void ref_fir_q15(const arm_fir_instance_q15 *S, q15_t *pSrc, q15_t *pDst,
                 uint32_t blockSize);

void ref_fir_fast_q15(const arm_fir_instance_q15 *S, q15_t *pSrc, q15_t *pDst,
                      uint32_t blockSize);

void ref_fir_q7(const arm_fir_instance_q7 *S, q7_t *pSrc, q7_t *pDst,
                uint32_t blockSize);

void ref_fir_decimate_f32(const arm_fir_decimate_instance_f32 *S,
                          float32_t *pSrc, float32_t *pDst, uint32_t blockSize);

void ref_fir_decimate_q31(const arm_fir_decimate_instance_q31 *S, q31_t *pSrc,
                          q31_t *pDst, uint32_t blockSize);

void ref_fir_decimate_fast_q31(const arm_fir_decimate_instance_q31 *S,
                               q31_t *pSrc, q31_t *pDst, uint32_t blockSize);

void ref_fir_decimate_q15(const arm_fir_decimate_instance_q15 *S, q15_t *pSrc,
                          q15_t *pDst, uint32_t blockSize);

void ref_fir_decimate_fast_q15(const arm_fir_decimate_instance_q15 *S,
                               q15_t *pSrc, q15_t *pDst, uint32_t blockSize);

void ref_fir_lattice_f32(const arm_fir_lattice_instance_f32 *S, float32_t *pSrc,
                         float32_t *pDst, uint32_t blockSize);

void ref_fir_lattice_q31(const arm_fir_lattice_instance_q31 *S, q31_t *pSrc,
                         q31_t *pDst, uint32_t blockSize);

void ref_fir_lattice_q15(const arm_fir_lattice_instance_q15 *S, q15_t *pSrc,
                         q15_t *pDst, uint32_t blockSize);

void ref_fir_sparse_f32(arm_fir_sparse_instance_f32 *S, float32_t *pSrc,
                        float32_t *pDst, float32_t *pScratchIn,
                        uint32_t blockSize);

void ref_fir_sparse_q31(arm_fir_sparse_instance_q31 *S, q31_t *pSrc,
                        q31_t *pDst, q31_t *pScratchIn, uint32_t blockSize);

void ref_fir_sparse_q15(arm_fir_sparse_instance_q15 *S, q15_t *pSrc,
                        q15_t *pDst, q15_t *pScratchIn, q31_t *pScratchOut,
                        uint32_t blockSize);

void ref_fir_sparse_q7(arm_fir_sparse_instance_q7 *S, q7_t *pSrc, q7_t *pDst,
                       q7_t *pScratchIn, q31_t *pScratchOut,
                       uint32_t blockSize);

void ref_iir_lattice_f32(const arm_iir_lattice_instance_f32 *S, float32_t *pSrc,
                         float32_t *pDst, uint32_t blockSize);

void ref_iir_lattice_q31(const arm_iir_lattice_instance_q31 *S, q31_t *pSrc,
                         q31_t *pDst, uint32_t blockSize);

void ref_iir_lattice_q15(const arm_iir_lattice_instance_q15 *S, q15_t *pSrc,
                         q15_t *pDst, uint32_t blockSize);

void ref_lms_f32(const arm_lms_instance_f32 *S, float32_t *pSrc,
                 float32_t *pRef, float32_t *pOut, float32_t *pErr,
                 uint32_t blockSize);

void ref_lms_norm_f32(arm_lms_norm_instance_f32 *S, float32_t *pSrc,
                      float32_t *pRef, float32_t *pOut, float32_t *pErr,
                      uint32_t blockSize);

void ref_lms_q31(const arm_lms_instance_q31 *S, q31_t *pSrc, q31_t *pRef,
                 q31_t *pOut, q31_t *pErr, uint32_t blockSize);

void ref_lms_norm_q31(arm_lms_norm_instance_q31 *S, q31_t *pSrc, q31_t *pRef,
                      q31_t *pOut, q31_t *pErr, uint32_t blockSize);

void ref_lms_q15(const arm_lms_instance_q15 *S, q15_t *pSrc, q15_t *pRef,
                 q15_t *pOut, q15_t *pErr, uint32_t blockSize);

void ref_lms_norm_q15(arm_lms_norm_instance_q15 *S, q15_t *pSrc, q15_t *pRef,
                      q15_t *pOut, q15_t *pErr, uint32_t blockSize);

void ref_fir_interpolate_f32(const arm_fir_interpolate_instance_f32 *S,
                             float32_t *pSrc, float32_t *pDst,
                             uint32_t blockSize);

void ref_fir_interpolate_q31(const arm_fir_interpolate_instance_q31 *S,
                             q31_t *pSrc, q31_t *pDst, uint32_t blockSize);

void ref_fir_interpolate_q15(const arm_fir_interpolate_instance_q15 *S,
                             q15_t *pSrc, q15_t *pDst, uint32_t blockSize);

/*
 * Matrix Functions
 */
arm_status ref_mat_cmplx_mult_f32(const arm_matrix_instance_f32 *pSrcA,
                                  const arm_matrix_instance_f32 *pSrcB,
                                  arm_matrix_instance_f32 *pDst);

arm_status ref_mat_cmplx_mult_q31(const arm_matrix_instance_q31 *pSrcA,
                                  const arm_matrix_instance_q31 *pSrcB,
                                  arm_matrix_instance_q31 *pDst);

arm_status ref_mat_cmplx_mult_q15(const arm_matrix_instance_q15 *pSrcA,
                                  const arm_matrix_instance_q15 *pSrcB,
                                  arm_matrix_instance_q15 *pDst);

arm_status ref_mat_inverse_f32(const arm_matrix_instance_f32 *pSrc,
                               arm_matrix_instance_f32 *pDst);

arm_status ref_mat_inverse_f64(const arm_matrix_instance_f64 *pSrc,
                               arm_matrix_instance_f64 *pDst);

arm_status ref_mat_mult_f32(const arm_matrix_instance_f32 *pSrcA,
                            const arm_matrix_instance_f32 *pSrcB,
                            arm_matrix_instance_f32 *pDst);

arm_status ref_mat_mult_q31(const arm_matrix_instance_q31 *pSrcA,
                            const arm_matrix_instance_q31 *pSrcB,
                            arm_matrix_instance_q31 *pDst);
...
arm_status ref_mat_mult_q15(const arm_matrix_instance_q15 *pSrcA,
                            const arm_matrix_instance_q15 *pSrcB,
                            arm_matrix_instance_q15 *pDst);
...
arm_status ref_mat_scale_f32(const arm_matrix_instance_f32 *pSrc,
                             float32_t scale, arm_matrix_instance_f32 *pDst);

arm_status ref_mat_scale_q31(const arm_matrix_instance_q31 *pSrc, q31_t scale,
                             int32_t shift, arm_matrix_instance_q31 *pDst);

arm_status ref_mat_scale_q15(const arm_matrix_instance_q15 *pSrc, q15_t scale,
                             int32_t shift, arm_matrix_instance_q15 *pDst);

arm_status ref_mat_sub_f32(const arm_matrix_instance_f32 *pSrcA,
                           const arm_matrix_instance_f32 *pSrcB,
                           arm_matrix_instance_f32 *pDst);

arm_status ref_mat_sub_q31(const arm_matrix_instance_q31 *pSrcA,
                           const arm_matrix_instance_q31 *pSrcB,
                           arm_matrix_instance_q31 *pDst);

arm_status ref_mat_sub_q15(const arm_matrix_instance_q15 *pSrcA,
                           const arm_matrix_instance_q15 *pSrcB,
                           arm_matrix_instance_q15 *pDst);

arm_status ref_mat_trans_f64(const arm_matrix_instance_f64 *pSrc,
                             arm_matrix_instance_f64 *pDst);

arm_status ref_mat_trans_f32(const arm_matrix_instance_f32 *pSrc,
                             arm_matrix_instance_f32 *pDst);

arm_status ref_mat_trans_q31(const arm_matrix_instance_q31 *pSrc,
                             arm_matrix_instance_q31 *pDst);

arm_status ref_mat_trans_q15(const arm_matrix_instance_q15 *pSrc,
                             arm_matrix_instance_q15 *pDst);

arm_status ref_mat_add_f32(const arm_matrix_instance_f32 *pSrcA,
                           const arm_matrix_instance_f32 *pSrcB,
                           arm_matrix_instance_f32 *pDst);

arm_status ref_mat_add_q31(const arm_matrix_instance_q31 *pSrcA,
                           const arm_matrix_instance_q31 *pSrcB,
                           arm_matrix_instance_q31 *pDst);

arm_status ref_mat_add_q15(const arm_matrix_instance_q15 *pSrcA,
                           const arm_matrix_instance_q15 *pSrcB,
                           arm_matrix_instance_q15 *pDst);
 ...
 * Transform Functions
 */
void ref_cfft_f32(const arm_cfft_instance_f32 *S, float32_t *p1,
                  uint8_t ifftFlag, uint8_t bitReverseFlag);

void ref_cfft_q31(const arm_cfft_instance_q31 *S, q31_t *p1, uint8_t ifftFlag,
                  uint8_t bitReverseFlag);

void ref_cfft_q15(const arm_cfft_instance_q15 *S, q15_t *p1, uint8_t ifftFlag,
                  uint8_t bitReverseFlag);

void ref_cfft_radix2_f32(const arm_cfft_radix2_instance_f32 *S,
                         float32_t *pSrc);

void ref_cfft_radix2_q31(const arm_cfft_radix2_instance_q31 *S, q31_t *pSrc);

void ref_cfft_radix2_q15(const arm_cfft_radix2_instance_q15 *S, q15_t *pSrc);

void ref_cfft_radix4_f32(const arm_cfft_radix4_instance_f32 *S,
                         float32_t *pSrc);

void ref_cfft_radix4_q31(const arm_cfft_radix4_instance_q31 *S, q31_t *pSrc);

void ref_cfft_radix4_q15(const arm_cfft_radix4_instance_q15 *S, q15_t *pSrc);

void ref_rfft_f32(arm_rfft_instance_f32 *S, float32_t *pSrc, float32_t *pDst);

void ref_rfft_fast_f32(arm_rfft_fast_instance_f32 *S, float32_t *p,
                       float32_t *pOut, uint8_t ifftFlag);

void ref_rfft_q31(const arm_rfft_instance_q31 *S, q31_t *pSrc, q31_t *pDst);

void ref_rfft_q15(const arm_rfft_instance_q15 *S, q15_t *pSrc, q15_t *pDst);

void ref_dct4_f32(const arm_dct4_instance_f32 *S, float32_t *pState,
                  float32_t *pInlineBuffer);

void ref_dct4_q31(const arm_dct4_instance_q31 *S, q31_t *pState,
                  q31_t *pInlineBuffer);

void ref_dct4_q15(const arm_dct4_instance_q15 *S, q15_t *pState,
                  q15_t *pInlineBuffer);
