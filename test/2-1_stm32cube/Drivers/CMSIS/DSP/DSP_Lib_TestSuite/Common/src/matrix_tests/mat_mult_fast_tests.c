...
#define JTEST_ARM_MAT_MULT_FAST_TEST(suffix)                                   \
  MATRIX_DEFINE_TEST_TEMPLATE_ELT2(                                            \
      mat_mult_fast, suffix, MATRIX_TEST_CONFIG_MULTIPLICATIVE_OUTPUT,         \
...
JTEST_DEFINE_TEST(arm_mat_mult_fast_q15_test, arm_mat_mult_fast_q15) {
  MATRIX_TEST_TEMPLATE_ELT2(
      ...
      arm_matrix_instance_q15, TYPE_FROM_ABBREV(q15), arm_mat_mult_fast_q15,
      ARM_mat_mult_fast_q15_INPUT_INTERFACE, ref_mat_mult_fast_q15,
