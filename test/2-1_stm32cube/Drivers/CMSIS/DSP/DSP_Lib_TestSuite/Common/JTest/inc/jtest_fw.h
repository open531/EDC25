 ...
 */
#define JTEST_ACT_TEST_START() JTEST_TRIGGER_ACTION(test_start)

/**
 *  Trigger the "Test End" action in the Keil Debugger.
 */
#define JTEST_ACT_TEST_END() JTEST_TRIGGER_ACTION(test_end)

/**
 *  Trigger the "Group Start" action in the Keil Debugger.
 */
#define JTEST_ACT_GROUP_START() JTEST_TRIGGER_ACTION(group_start)

/**
 *  Trigger the "Group End" action in the Keil Debugger.
 */
#define JTEST_ACT_GROUP_END() JTEST_TRIGGER_ACTION(group_end)
 ...
 */
#define JTEST_CLEAR_STR_BUFFER() JTEST_CLEAR_BUFFER(str_buffer)

/**
 *  Clear the memory needed for the JTEST_FW's data buffer.
 */
#define JTEST_CLEAR_DATA_BUFFER() JTEST_CLEAR_BUFFER(data_buffer)

/**
 *  Dump the given string to the Keil Debugger.
 */
#define JTEST_DUMP_STR(string) JTEST_ACT_DUMP(dump_str, str_buffer, string)
 ...
 */
#define JTEST_FW_INC_PASSED(amount) JTEST_PF_INC_PASSED(&JTEST_FW, amount)

/**
 *  Increment the number of passed tests in #JTEST_FW.
 */
#define JTEST_FW_INC_FAILED(amount) JTEST_PF_INC_FAILED(&JTEST_FW, amount)
