 ...
 */
#define JTEST_GROUP_FN_TEMPLATE(group_fn) void group_fn(void)

#define JTEST_GROUP_FN_PROTOTYPE                                               \
  JTEST_GROUP_FN_TEMPLATE /**< Alias for                                       \
...
#define JTEST_GROUP_DEFINE_STRUCT(group_fn)                                    \
  JTEST_DEFINE_STRUCT(JTEST_GROUP_t, JTEST_GROUP_STRUCT_NAME(group_fn))
...
#define JTEST_GROUP_STRUCT_INIT(group_fn)                                      \
  group_fn, STR_NL(group_fn), JTEST_PF_MEMBER_INIT

/**
 *  Initialize the contents of a #JTEST_GROUP_t struct.
 */
#define JTEST_GROUP_INIT(group_fn)                                             \
  JTEST_GROUP_DEFINE_STRUCT(group_fn) = {JTEST_GROUP_STRUCT_INIT(group_fn)}
