 ...
 */
#define JTEST_TEST_FN_TEMPLATE(test_fn) JTEST_TEST_RET_t test_fn(void)

#define JTEST_TEST_FN_PROTOTYPE                                                \
  JTEST_TEST_FN_TEMPLATE /**< Alias for                                        \
...
#define JTEST_TEST_DEFINE_STRUCT(test_fn)                                      \
  JTEST_DEFINE_STRUCT(JTEST_TEST_t, JTEST_TEST_STRUCT_NAME(test_fn))
...
#define JTEST_TEST_STRUCT_INIT(test_fn, fut, enable)                           \
  test_fn, STR_NL(test_fn), STR_NL(fut), {                                     \
    { enable, 0 }                                                              \
  }
...
/* Dispatch Macro*/
#define JTEST_DEFINE_TEST_(N, ...) SPLICE(JTEST_DEFINE_TEST_, N)(__VA_ARGS__)
...
#define JTEST_DEFINE_TEST_1(_1)                                                \
  _JTEST_DEFINE_TEST(_1, JTEST_DEFINE_TEST_DEFAULT_FUT,                        \
                     JTEST_DEFINE_TEST_DEFAULT_ENABLE)

#define JTEST_DEFINE_TEST_2(_1, _2)                                            \
  _JTEST_DEFINE_TEST(_1, _2, JTEST_DEFINE_TEST_DEFAULT_ENABLE)

#define JTEST_DEFINE_TEST_3(_1, _2, _3) _JTEST_DEFINE_TEST(_1, _2, _3)
