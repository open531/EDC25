 ...
 */
#define SUPPORT_COMPARE_INTERFACE(block_size, output_type)                     \
  do {                                                                         \
    TEST_ASSERT_BUFFERS_EQUAL(support_output_ref.data_ptr,                     \
 ...
 */
#define SUPPORT_DEFINE_TEST_TEMPLATE_BUF1_BLK(                                 \
  ...
  JTEST_DEFINE_TEST(arm_##fn_name##_##suffix##_test,                           \
    ...
    TEST_TEMPLATE_BUF1_BLK(                                                    \
        support_f_all, support_block_sizes, input_type, output_type,           \
 ...
 *  REF_xxx_INPUT_INTERFACEs.
 */
#define SUPPORT_DEFINE_TEST_TEMPLATE_ELT1_BLK(                                 \
    fn_name, suffix, elt_type, output_type, comparison_interface)              \
  JTEST_DEFINE_TEST(arm_##fn_name##_##suffix##_test,                           \
                    arm_##fn_name##_##suffix) {                                \
    TEST_TEMPLATE_ELT1_BLK(                                                    \
        support_elts, support_block_sizes, elt_type, output_type,              \
        arm_##fn_name##_##suffix, ARM_##fn_name##_INPUT_INTERFACE,             \
        ref_##fn_name##_##suffix, REF_##fn_name##_INPUT_INTERFACE,             \
        comparison_interface);                                                 \
  }
