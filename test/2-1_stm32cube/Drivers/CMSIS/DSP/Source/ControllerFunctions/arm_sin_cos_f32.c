 ...
 *
 * Computes the trigonometric sine and cosine values using a combination of
 * table lookup and linear interpolation. There are separate functions for Q31
 * and floating-point data types. The input to the floating-point version is in
...
void arm_sin_cos_f32(float32_t theta, float32_t *pSinVal, float32_t *pCosVal) {
  ...
  /* Scale the input, divide input by 360, for cosine add 0.25 (pi/2) to read
   * sine table */
