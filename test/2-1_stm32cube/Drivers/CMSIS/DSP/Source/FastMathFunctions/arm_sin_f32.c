 ...
 * The input to the floating-point version is in radians and in the range [0
 * 2*pi) while the fixed-point Q15 and Q31 have a scaled input with the range [0
 * +0.9999] mapping to [0 2*pi).  The fixed-point range is chosen so that a
