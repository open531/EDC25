 ...
 *must be scaled down by log2(blockSize) bits, as a total of blockSize additions
 *are performed internally. Finally, the 2.62 accumulator is right shifted by 31
 *bits to yield a 1.31 format value.
 *
 */
