 ...
 * overflows completely the input signal must be scaled down by two bits and lie
 * in the range [-0.25 +0.25). The 2.30 accumulator is then shifted by
 * <code>postShift</code> bits and the result truncated to 1.15 format by
 * discarding the low 16 bits.
 *
 * \par
 * Refer to the function <code>arm_biquad_cascade_df1_q15()</code> for a slower
 ...
 * structure. Use the function <code>arm_biquad_cascade_df1_init_q15()</code> to
