 ...
 *
 * \par
 * Fast versions are supported for Q31 and Q15 of partial convolution.  Cycles
 * for Fast versions are less compared to Q31 and Q15 of partial conv and the
 * design requires the input signals should be scaled down to avoid intermediate
 * overflows.
 *
 *
 * <b>Opt Versions</b>
