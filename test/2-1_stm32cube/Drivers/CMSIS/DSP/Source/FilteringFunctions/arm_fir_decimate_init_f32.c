 ...
 * @param[in,out] *S points to an instance of the floating-point FIR decimator
 * structure.
 ...
 * <code>pState</code> is of length <code>numTaps+blockSize-1</code> words where
 * <code>blockSize</code> is the number of input samples passed to
 * <code>arm_fir_decimate_f32()</code>. <code>M</code> is the decimation factor.
 */
