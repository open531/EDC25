 ...
 * The 1.15 x 1.15 multiplications yield a 2.30 result and these are added to
 * a 2.30 accumulator. Thus the full precision of the multiplications is
...
void arm_fir_sparse_q15(arm_fir_sparse_instance_q15 *S, q15_t *pSrc,
  ...
  arm_circularRead_q15(py, delaySize, &readIndex, 1, pb, pb, blockSize, 1,
                       blockSize);
