 ...
 *
 * \par
 * Refer to <code>arm_conv_fast_q15()</code> for a faster but less precise
 * version of this function for Cortex-M3 and Cortex-M4.
 *
 * \par
 * Refer the function <code>arm_conv_opt_q15()</code> for a faster
...
void arm_conv_q15(q15_t *pSrcA, uint32_t srcALen, q15_t *pSrcB,
  ...
  uint32_t blockSize1, blockSize2, blockSize3, j, k, count,
      blkCnt; /* loop counter */
