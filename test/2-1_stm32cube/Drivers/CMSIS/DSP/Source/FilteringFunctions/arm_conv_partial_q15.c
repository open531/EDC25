 ...
 * srcALen+srcBLen-2].
 *
 * Refer to <code>arm_conv_partial_fast_q15()</code> for a faster but less
 * precise version of this function for Cortex-M3 and Cortex-M4.
 *
 * \par
 * Refer the function <code>arm_conv_partial_opt_q15()</code> for a faster
