 ...
 * <code>blockSize</code> is the number of input samples to the call
 * <code>arm_fir_decimate_q15()</code>. <code>M</code> is the decimation factor.
 */
...
arm_status arm_fir_decimate_init_q15(arm_fir_decimate_instance_q15 *S,
  ...
  if ((blockSize % M) != 0U) {
    ...
    /* Clear the state buffer.  The size of buffer is always (blockSize +
     * numTaps - 1) */
