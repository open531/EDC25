 ...
 * results in an <code>M x P</code> matrix. When matrix size checking is
 * enabled, the functions check: (1) that the inner dimensions of
 * <code>pSrcA</code> and <code>pSrcB</code> are equal; and (2) that the size of
 * the output matrix equals the outer dimensions of <code>pSrcA</code> and
 * <code>pSrcB</code>.
 */
