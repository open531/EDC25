...
void arm_split_rfft_q15(q15_t *pSrc, uint32_t fftLen, q15_t *pATable,
                        q15_t *pBTable, q15_t *pDst, uint32_t modifier);

void arm_split_rifft_q15(q15_t *pSrc, uint32_t fftLen, q15_t *pATable,
                         q15_t *pBTable, q15_t *pDst, uint32_t modifier);
 ...
 * RFFT sizes. The input and output formats for different RFFT sizes and number
 * of bits to upscale are mentioned in the tables below for RFFT and RIFFT: \par
 ...
 * @param  modifier 	        twiddle coefficient modifier that supports
