/**
  ...
  ******************************************************************************
  ...
  HAL_GPIOEx_ConfigEventout()
    ...
    (#) Deactivate EVENTOUT Cortex feature using the
 ...
 * be connected.
 * @param  GPIO_PortSource Select the port used to output the Cortex EVENTOUT
 * signal. This parameter can be a value of @ref GPIOEx_EVENTOUT_PORT.
 * @param  GPIO_PinSource Select the pin used to output the Cortex EVENTOUT
 * signal. This parameter can be a value of @ref GPIOEx_EVENTOUT_PIN.
 * @retval None
 */
void HAL_GPIOEx_ConfigEventout(uint32_t GPIO_PortSource,
  ...
  MODIFY_REG(AFIO->EVCR, (AFIO_EVCR_PORT) | (AFIO_EVCR_PIN),
             (GPIO_PortSource) | (GPIO_PinSource));
}
