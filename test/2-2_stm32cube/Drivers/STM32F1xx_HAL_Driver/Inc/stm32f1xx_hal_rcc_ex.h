...
#define RCC_CR_PLLI2SON_BB                                                     \
  ((uint32_t)(PERIPH_BB_BASE + (RCC_CR_OFFSET_BB * 32U) +                      \
              (PLLI2SON_BITNUMBER * 4U)))
/* Alias word address of PLL2ON bit */
#define PLL2ON_BITNUMBER RCC_CR_PLL2ON_Pos
#define RCC_CR_PLL2ON_BB                                                       \
  ((uint32_t)(PERIPH_BB_BASE + (RCC_CR_OFFSET_BB * 32U) +                      \
              (PLL2ON_BITNUMBER * 4U)))
...
#if defined(STM32F105xC) || defined(STM32F107xC)
#define IS_RCC_PREDIV1_SOURCE(__SOURCE__)                                      \
  (((__SOURCE__) == RCC_PREDIV1_SOURCE_HSE) ||                                 \
...
#define IS_RCC_HSE_PREDIV(__DIV__)                                             \
  (((__DIV__) == RCC_HSE_PREDIV_DIV1) || ((__DIV__) == RCC_HSE_PREDIV_DIV2) || \
   ...
   ((__DIV__) == RCC_HSE_PREDIV_DIV9) ||                                       \
   ((__DIV__) == RCC_HSE_PREDIV_DIV10) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV_DIV11) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV_DIV12) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV_DIV13) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV_DIV14) ||                                      \
...
#define IS_RCC_MCO1SOURCE(__SOURCE__)                                          \
  (((__SOURCE__) == RCC_MCO1SOURCE_SYSCLK) ||                                  \
   ...
   ((__SOURCE__) == RCC_MCO1SOURCE_PLL2CLK) ||                                 \
   ((__SOURCE__) == RCC_MCO1SOURCE_PLL3CLK) ||                                 \
   ((__SOURCE__) == RCC_MCO1SOURCE_PLL3CLK_DIV2) ||                            \
   ((__SOURCE__) == RCC_MCO1SOURCE_EXT_HSE) ||                                 \
...
#define IS_RCC_ADCPLLCLK_DIV(__ADCCLK__)                                       \
  (((__ADCCLK__) == RCC_ADCPCLK2_DIV2) ||                                      \
   ((__ADCCLK__) == RCC_ADCPCLK2_DIV4) ||                                      \
...
#define IS_RCC_I2S3CLKSOURCE(__SOURCE__)                                       \
  (((__SOURCE__) == RCC_I2S3CLKSOURCE_SYSCLK) ||                               \
   ((__SOURCE__) == RCC_I2S3CLKSOURCE_PLLI2S_VCO))

#define IS_RCC_USBPLLCLK_DIV(__USBCLK__)                                       \
  (((__USBCLK__) == RCC_USBCLKSOURCE_PLL_DIV2) ||                              \
   ((__USBCLK__) == RCC_USBCLKSOURCE_PLL_DIV3))

#define IS_RCC_PLLI2S_MUL(__MUL__)                                             \
  (((__MUL__) == RCC_PLLI2S_MUL8) || ((__MUL__) == RCC_PLLI2S_MUL9) ||         \
...
#define IS_RCC_HSE_PREDIV2(__DIV__)                                            \
  (((__DIV__) == RCC_HSE_PREDIV2_DIV1) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV2) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV3) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV4) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV5) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV6) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV7) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV8) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV9) ||                                      \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV10) ||                                     \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV11) ||                                     \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV12) ||                                     \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV13) ||                                     \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV14) ||                                     \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV15) ||                                     \
   ((__DIV__) == RCC_HSE_PREDIV2_DIV16))

#define IS_RCC_PLL2(__PLL__)                                                   \
  (((__PLL__) == RCC_PLL2_NONE) || ((__PLL__) == RCC_PLL2_OFF) ||              \
   ((__PLL__) == RCC_PLL2_ON))

#define IS_RCC_PLL2_MUL(__MUL__)                                               \
  (((__MUL__) == RCC_PLL2_MUL8) || ((__MUL__) == RCC_PLL2_MUL9) ||             \
...
#define IS_RCC_USBPLLCLK_DIV(__USBCLK__)                                       \
  (((__USBCLK__) == RCC_USBCLKSOURCE_PLL) ||                                   \
   ((__USBCLK__) == RCC_USBCLKSOURCE_PLL_DIV1_5))

#endif /* STM32F102x6 || STM32F102xB || STM32F103x6 || STM32F103xB ||          \
...
typedef struct {
  uint32_t
      PLL2State; /*!< The new state of the PLL2.
...
typedef struct {
  ...
  uint32_t HSEPredivValue; /*!<  The Prediv1 factor value (named PREDIV1 or
                              PLLXTPRE in RM) This parameter can be a value of
                              @ref RCCEx_Prediv1_Factor */
  ...
  uint32_t HSICalibrationValue; /*!< The HSI calibration trimming value (default
                                   is RCC_HSICALIBRATION_DEFAULT). This
 ...
 */
typedef struct {
  uint32_t PLLI2SMUL; /*!< PLLI2SMUL: Multiplication factor for PLLI2S VCO input
                      clock This parameter must be a value of @ref
                      RCCEx_PLLI2S_Multiplication_Factor*/
...
typedef struct {
  ...
  uint32_t I2s2ClockSelection; /*!< I2S2 clock source
                               This parameter can be a value of @ref
                               RCCEx_I2S2_Clock_Source */

  uint32_t I2s3ClockSelection; /*!< I2S3 clock source
                               This parameter can be a value of @ref
                               RCCEx_I2S3_Clock_Source */

#if defined(STM32F105xC) || defined(STM32F107xC)
  RCC_PLLI2SInitTypeDef
      PLLI2S; /*!< PLL I2S structure parameters
                   This parameter will be used only when PLLI2S is selected as
                 Clock Source I2S2 or I2S3 */
...
#define RCC_FLAG_PLLI2SRDY                                                     \
  ((uint8_t)((CR_REG_INDEX << 5U) | RCC_CR_PLL3RDY_Pos))
/**
 * @}
 */
#endif /* STM32F105xC || STM32F107xC*/
...
/** @defgroup RCCEx_Peripheral_Clock_Enable_Disable Peripheral Clock Enable
 * Disable
...
#define __HAL_RCC_DMA2_CLK_DISABLE() (RCC->AHBENR &= ~(RCC_AHBENR_DMA2EN))
          ...
          STM32F105xC || STM32F107xC || STM32F100xE */
...
/** @defgroup RCCEx_AHB1_Peripheral_Clock_Enable_Disable_Status AHB1 Peripheral
 * Clock Enable Disable Status
...
#define __HAL_RCC_DMA2_IS_CLK_ENABLED()                                        \
  ((RCC->AHBENR & (RCC_AHBENR_DMA2EN)) != RESET)
...
#define __HAL_RCC_FSMC_IS_CLK_ENABLED()                                        \
  ((RCC->AHBENR & (RCC_AHBENR_FSMCEN)) != RESET)
...
#endif /* STM32F103x6 || STM32F103xB || STM32F103xE || STM32F103xG ||          \
          STM32F105xC || STM32F107xC */
...
#endif /* STM32F100xB || STM32F101xB || STM32F101xE || (...) || STM32F105xC || \
          STM32F107xC */
...
#endif /* STM32F101xE || STM32F103xE || STM32F101xG || (...) || STM32F105xC || \
          STM32F107xC */
...
/** @defgroup RCCEx_APB1_Peripheral_Clock_Enable_Disable_Status APB1 Peripheral
 * Clock Enable Disable Status
...
#define __HAL_RCC_USB_IS_CLK_ENABLED()                                         \
  ((RCC->APB1ENR & (RCC_APB1ENR_USBEN)) != RESET)
...
#endif /* STM32F101xG || STM32F103x6 || STM32F103xB || STM32F105xC ||          \
          STM32F107xC || STM32F103xE || STM32F103xG */
...
#endif /* STM32F101x6 || STM32F101xB || STM32F101xE || (...) || STM32F105xC || \
          STM32F107xC */
...
/** @defgroup RCCEx_APB2_Peripheral_Clock_Enable_Disable_Status APB2 Peripheral
 * Clock Enable Disable Status
...
#define __HAL_RCC_GPIOE_IS_CLK_ENABLED()                                       \
  ((RCC->APB2ENR & (RCC_APB2ENR_IOPEEN)) != RESET)
...
#if defined(STM32F105xC) || defined(STM32F107xC)
/** @defgroup RCCEx_Peripheral_Clock_Force_Release Peripheral Clock Force
 * Release
...
#define __HAL_RCC_ADC2_RELEASE_RESET()                                         \
...
#define __HAL_RCC_ADC3_RELEASE_RESET()                                         \
 ...
 * @note   After enabling the main PLLI2S, the application software should wait
 * on PLLI2SRDY flag to be set indicating that PLLI2S clock is stable and can be
 * used as system clock source.
 * @note   The main PLLI2S is disabled by hardware when entering STOP and
 * STANDBY modes.
 */
 ...
 *
 * @param  __PLLI2SMUL__ specifies the multiplication factor for PLLI2S VCO
 * output clock This parameter can be one of the following values:
 ...
 *            @arg @ref RCC_USBCLKSOURCE_PLL PLL clock divided by 1 selected as
 * USB clock
 *            @arg @ref RCC_USBCLKSOURCE_PLL_DIV1_5 PLL clock divided by 1.5
...
#define __HAL_RCC_GET_USB_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->CFGR, RCC_CFGR_USBPRE)))
 ...
 * @param  __USBCLKSOURCE__ specifies the USB clock source.
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_USBCLKSOURCE_PLL_DIV2 PLL clock divided by 2
 * selected as USB OTG FS clock
 *            @arg @ref RCC_USBCLKSOURCE_PLL_DIV3 PLL clock divided by 3
 * selected as USB OTG FS clock
 */
#define __HAL_RCC_USB_CONFIG(__USBCLKSOURCE__)                                 \
 ...
 */
#define __HAL_RCC_GET_USB_SOURCE()                                             \
  ((uint32_t)(READ_BIT(RCC->CFGR, RCC_CFGR_OTGFSPRE)))
 ...
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_ADCPCLK2_DIV2 PCLK2 clock divided by 2 selected as
 * ADC clock
 *            @arg @ref RCC_ADCPCLK2_DIV4 PCLK2 clock divided by 4 selected as
 * ADC clock
 *            @arg @ref RCC_ADCPCLK2_DIV6 PCLK2 clock divided by 6 selected as
 * ADC clock
 *            @arg @ref RCC_ADCPCLK2_DIV8 PCLK2 clock divided by 8 selected as
 * ADC clock
 */
 ...
 * @note   Predivision factor can not be changed if PLL2 is used indirectly as
 * system clock In this case, you have to select another source of the system
 * clock, disable the PLL2 and PLLI2S and then change the PREDIV2 factor.
 * @param  __HSE_PREDIV2_VALUE__ specifies the PREDIV2 value applied to PLL2 &
 * PLLI2S. This parameter must be a number between RCC_HSE_PREDIV2_DIV1 and
 ...
 * @note   The main PLL2 is disabled by hardware when entering STOP and STANDBY
 * modes.
 */
#define __HAL_RCC_PLL2_ENABLE() (*(__IO uint32_t *)RCC_CR_PLL2ON_BB = ENABLE)

/** @brief Macros to disable the main PLL2.
 * @note   The main PLL2 can not be disabled if it is used indirectly as system
 * clock source
 * @note   The main PLL2 is disabled by hardware when entering STOP and STANDBY
 * modes.
 */
 ...
 *
 * @param  __PLL2MUL__ specifies the multiplication factor for PLL2 VCO output
 ...
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_I2S2CLKSOURCE_SYSCLK system clock selected as I2S3
 * clock entry
 *            @arg @ref RCC_I2S2CLKSOURCE_PLLI2S_VCO PLLI2S VCO clock selected
 * as I2S3 clock entry
 */
 ...
 * as I2S3 clock entry
 */
#define __HAL_RCC_GET_I2S2_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->CFGR2, RCC_CFGR2_I2S2SRC)))

/** @brief  Macro to configure the I2S3 clock.
 * @param  __I2S2CLKSOURCE__ specifies the I2S3 clock source.
 *          This parameter can be one of the following values:
 *            @arg @ref RCC_I2S3CLKSOURCE_SYSCLK system clock selected as I2S3
 * clock entry
 *            @arg @ref RCC_I2S3CLKSOURCE_PLLI2S_VCO PLLI2S VCO clock selected
 * as I2S3 clock entry
 */
 ...
 * as I2S3 clock entry
 */
#define __HAL_RCC_GET_I2S3_SOURCE()                                            \
  ((uint32_t)(READ_BIT(RCC->CFGR2, RCC_CFGR2_I2S3SRC)))
