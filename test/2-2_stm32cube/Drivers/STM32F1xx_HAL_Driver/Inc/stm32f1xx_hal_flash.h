...
typedef struct {
  ...
  __IO uint32_t
      DataRemaining; /*!< Internal variable to save the remaining pages to erase
                        or half-word to program in IT context */
...
/**
  ...
  * @note   half cycle access can only be used with a low-frequency clock of
  less than 8 MHz that can be obtained with the use of HSI or HSE but not of
  PLL.
  * @retval None
  */
...
/**
  ...
  * @retval None
  */
#define __HAL_FLASH_HALF_CYCLE_ACCESS_DISABLE()                                \
