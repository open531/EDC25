 ...
 * @{
 */
#define LL_GPIO_PIN_0                                                          \
  ((GPIO_BSRR_BS0 << GPIO_PIN_MASK_POS) | 0x00000001U) /*!< Select pin 0  */
#define LL_GPIO_PIN_1                                                          \
  ((GPIO_BSRR_BS1 << GPIO_PIN_MASK_POS) | 0x00000002U) /*!< Select pin 1  */
#define LL_GPIO_PIN_2                                                          \
  ((GPIO_BSRR_BS2 << GPIO_PIN_MASK_POS) | 0x00000004U) /*!< Select pin 2  */
#define LL_GPIO_PIN_3                                                          \
  ((GPIO_BSRR_BS3 << GPIO_PIN_MASK_POS) | 0x00000008U) /*!< Select pin 3  */
#define LL_GPIO_PIN_4                                                          \
  ((GPIO_BSRR_BS4 << GPIO_PIN_MASK_POS) | 0x00000010U) /*!< Select pin 4  */
#define LL_GPIO_PIN_5                                                          \
  ((GPIO_BSRR_BS5 << GPIO_PIN_MASK_POS) | 0x00000020U) /*!< Select pin 5  */
#define LL_GPIO_PIN_6                                                          \
  ((GPIO_BSRR_BS6 << GPIO_PIN_MASK_POS) | 0x00000040U) /*!< Select pin 6  */
#define LL_GPIO_PIN_7                                                          \
  ((GPIO_BSRR_BS7 << GPIO_PIN_MASK_POS) | 0x00000080U) /*!< Select pin 7  */
#define LL_GPIO_PIN_8                                                          \
  ((GPIO_BSRR_BS8 << GPIO_PIN_MASK_POS) | 0x04000001U) /*!< Select pin 8  */
#define LL_GPIO_PIN_9                                                          \
  ((GPIO_BSRR_BS9 << GPIO_PIN_MASK_POS) | 0x04000002U) /*!< Select pin 9  */
#define LL_GPIO_PIN_10                                                         \
  ((GPIO_BSRR_BS10 << GPIO_PIN_MASK_POS) | 0x04000004U) /*!< Select pin 10 */
#define LL_GPIO_PIN_11                                                         \
  ((GPIO_BSRR_BS11 << GPIO_PIN_MASK_POS) | 0x04000008U) /*!< Select pin 11 */
#define LL_GPIO_PIN_12                                                         \
  ((GPIO_BSRR_BS12 << GPIO_PIN_MASK_POS) | 0x04000010U) /*!< Select pin 12 */
#define LL_GPIO_PIN_13                                                         \
  ((GPIO_BSRR_BS13 << GPIO_PIN_MASK_POS) | 0x04000020U) /*!< Select pin 13 */
#define LL_GPIO_PIN_14                                                         \
  ((GPIO_BSRR_BS14 << GPIO_PIN_MASK_POS) | 0x04000040U) /*!< Select pin 14 */
#define LL_GPIO_PIN_15                                                         \
  ((GPIO_BSRR_BS15 << GPIO_PIN_MASK_POS) | 0x04000080U) /*!< Select pin 15 */
...
#define LL_GPIO_MODE_OUTPUT                                                    \
  GPIO_CRL_MODE0_0 /*!< Select general purpose output mode */
#define LL_GPIO_MODE_ALTERNATE                                                 \
  (GPIO_CRL_CNF0_1 | GPIO_CRL_MODE0_0) /*!< Select alternate function mode */
/**
 * @}
 */
...
#define LL_GPIO_OUTPUT_OPENDRAIN                                               \
  GPIO_CRL_CNF0_0 /*!< Select open-drain as output type */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_GPIO_MODE_OUTPUT_10MHz                                              \
  GPIO_CRL_MODE0_0 /*!< Select Output mode, max speed 10 MHz */
#define LL_GPIO_MODE_OUTPUT_2MHz                                               \
  GPIO_CRL_MODE0_1 /*!< Select Output mode, max speed 20 MHz */
#define LL_GPIO_MODE_OUTPUT_50MHz                                              \
  GPIO_CRL_MODE0 /*!< Select Output mode, max speed 50 MHz */
/**
 * @}
 */

#define LL_GPIO_SPEED_FREQ_LOW                                                 \
  LL_GPIO_MODE_OUTPUT_2MHz /*!< Select I/O low output speed    */
#define LL_GPIO_SPEED_FREQ_MEDIUM                                              \
  LL_GPIO_MODE_OUTPUT_10MHz /*!< Select I/O medium output speed */
#define LL_GPIO_SPEED_FREQ_HIGH                                                \
  LL_GPIO_MODE_OUTPUT_50MHz /*!< Select I/O high output speed   */
 ...
 * @{
 */
#define LL_GPIO_AF_EXTI_LINE0                                                  \
  (0x000FU << 16U | 0U) /*!< EXTI_POSITION_0  | EXTICR[0] */
#define LL_GPIO_AF_EXTI_LINE1                                                  \
  (0x00F0U << 16U | 0U) /*!< EXTI_POSITION_4  | EXTICR[0] */
#define LL_GPIO_AF_EXTI_LINE2                                                  \
  (0x0F00U << 16U | 0U) /*!< EXTI_POSITION_8  | EXTICR[0] */
#define LL_GPIO_AF_EXTI_LINE3                                                  \
  (0xF000U << 16U | 0U) /*!< EXTI_POSITION_12 | EXTICR[0] */
#define LL_GPIO_AF_EXTI_LINE4                                                  \
  (0x000FU << 16U | 1U) /*!< EXTI_POSITION_0  | EXTICR[1] */
#define LL_GPIO_AF_EXTI_LINE5                                                  \
  (0x00F0U << 16U | 1U) /*!< EXTI_POSITION_4  | EXTICR[1] */
#define LL_GPIO_AF_EXTI_LINE6                                                  \
  (0x0F00U << 16U | 1U) /*!< EXTI_POSITION_8  | EXTICR[1] */
#define LL_GPIO_AF_EXTI_LINE7                                                  \
  (0xF000U << 16U | 1U) /*!< EXTI_POSITION_12 | EXTICR[1] */
#define LL_GPIO_AF_EXTI_LINE8                                                  \
  (0x000FU << 16U | 2U) /*!< EXTI_POSITION_0  | EXTICR[2] */
#define LL_GPIO_AF_EXTI_LINE9                                                  \
  (0x00F0U << 16U | 2U) /*!< EXTI_POSITION_4  | EXTICR[2] */
#define LL_GPIO_AF_EXTI_LINE10                                                 \
  (0x0F00U << 16U | 2U) /*!< EXTI_POSITION_8  | EXTICR[2] */
#define LL_GPIO_AF_EXTI_LINE11                                                 \
  (0xF000U << 16U | 2U) /*!< EXTI_POSITION_12 | EXTICR[2] */
#define LL_GPIO_AF_EXTI_LINE12                                                 \
  (0x000FU << 16U | 3U) /*!< EXTI_POSITION_0  | EXTICR[3] */
#define LL_GPIO_AF_EXTI_LINE13                                                 \
  (0x00F0U << 16U | 3U) /*!< EXTI_POSITION_4  | EXTICR[3] */
#define LL_GPIO_AF_EXTI_LINE14                                                 \
  (0x0F00U << 16U | 3U) /*!< EXTI_POSITION_8  | EXTICR[3] */
#define LL_GPIO_AF_EXTI_LINE15                                                 \
  (0xF000U << 16U | 3U) /*!< EXTI_POSITION_12 | EXTICR[3] */
/**
 * @}
 */
...
__STATIC_INLINE void LL_GPIO_SetPinMode(GPIO_TypeDef *GPIOx, uint32_t Pin,
  ...
  register uint32_t *pReg =
      (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24)));
  MODIFY_REG(*pReg,
             ((GPIO_CRL_CNF0 | GPIO_CRL_MODE0) << (POSITION_VAL(Pin) * 4U)),
...
__STATIC_INLINE uint32_t LL_GPIO_GetPinMode(GPIO_TypeDef *GPIOx, uint32_t Pin) {
  register uint32_t *pReg =
      (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24)));
  return (READ_BIT(*pReg, ((GPIO_CRL_CNF0 | GPIO_CRL_MODE0)
                           << (POSITION_VAL(Pin) * 4U))) >>
          (POSITION_VAL(Pin) * 4U));
}
...
__STATIC_INLINE uint32_t LL_GPIO_GetPinSpeed(GPIO_TypeDef *GPIOx,
  ...
  register uint32_t *pReg =
      (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24)));
  return (READ_BIT(*pReg, (GPIO_CRL_MODE0 << (POSITION_VAL(Pin) * 4U))) >>
          (POSITION_VAL(Pin) * 4U));
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_SetPinOutputType(GPIO_TypeDef *GPIOx, uint32_t Pin,
                                              uint32_t OutputType) {
  register uint32_t *pReg =
      (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24)));
...
__STATIC_INLINE uint32_t LL_GPIO_GetPinOutputType(GPIO_TypeDef *GPIOx,
  ...
  register uint32_t *pReg =
      (uint32_t *)((uint32_t)((uint32_t)(&GPIOx->CRL) + (Pin >> 24)));
  return (READ_BIT(*pReg, (GPIO_CRL_CNF0_0 << (POSITION_VAL(Pin) * 4U))) >>
          (POSITION_VAL(Pin) * 4U));
}
...
__STATIC_INLINE void LL_GPIO_SetPinPull(GPIO_TypeDef *GPIOx, uint32_t Pin,
                                        uint32_t Pull) {
  MODIFY_REG(GPIOx->ODR, (Pin >> GPIO_PIN_MASK_POS),
             Pull << (POSITION_VAL(Pin >> GPIO_PIN_MASK_POS)));
}
...
__STATIC_INLINE void LL_GPIO_LockPin(GPIO_TypeDef *GPIOx, uint32_t PinMask) {
  __IO uint32_t temp;
  WRITE_REG(GPIOx->LCKR,
            GPIO_LCKR_LCKK | ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFU));
...
__STATIC_INLINE uint32_t LL_GPIO_IsPinLocked(GPIO_TypeDef *GPIOx,
                                             uint32_t PinMask) {
  return (
      READ_BIT(GPIOx->LCKR, ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFU)) ==
      ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFU));
}
...
__STATIC_INLINE uint32_t LL_GPIO_IsInputPinSet(GPIO_TypeDef *GPIOx,
                                               uint32_t PinMask) {
  return (READ_BIT(GPIOx->IDR, (PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFU) ==
          ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFU));
}
...
__STATIC_INLINE uint32_t LL_GPIO_IsOutputPinSet(GPIO_TypeDef *GPIOx,
                                                uint32_t PinMask) {
  return (READ_BIT(GPIOx->ODR, (PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFU) ==
          ((PinMask >> GPIO_PIN_MASK_POS) & 0x0000FFFFU));
}
 ...
 * @brief This section propose definition to remap the alternate function to
 * some other port/pins.
 * @{
 */

/**
 * @brief  Enable the remapping of SPI1 alternate function NSS, SCK, MISO and
 * MOSI.
...
/**
 * @brief Disable the remapping of SPI1 alternate function NSS, SCK, MISO and
 * MOSI.
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_I2C1(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_I2C1_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_USART1(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_USART1_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_USART1(void) {
  return (READ_BIT(AFIO->MAPR, AFIO_MAPR_USART1_REMAP) ==
          (AFIO_MAPR_USART1_REMAP));
}

/**
 * @brief Enable the remapping of USART2 alternate function CTS, RTS, CK, TX and
 * RX.
...
/**
 * @brief Disable the remapping of USART2 alternate function CTS, RTS, CK, TX
 * and RX.
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_USART2(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_USART2_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_USART2(void) {
  return (READ_BIT(AFIO->MAPR, AFIO_MAPR_USART2_REMAP) ==
          (AFIO_MAPR_USART2_REMAP));
}

#if defined(AFIO_MAPR_USART3_REMAP)
/**
 * @brief Enable the remapping of USART3 alternate function CTS, RTS, CK, TX and
 * RX.
...
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_USART3(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_USART3_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_USART3_REMAP_FULLREMAP | AFIO_MAPR_SWJ_CFG));
}
...
__STATIC_INLINE void LL_GPIO_AF_RemapPartial_USART3(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_USART3_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_USART3_REMAP_PARTIALREMAP | AFIO_MAPR_SWJ_CFG));
}

/**
 * @brief Disable the remapping of USART3 alternate function CTS, RTS, CK, TX
 * and RX.
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_USART3(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_USART3_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_USART3_REMAP_NOREMAP | AFIO_MAPR_SWJ_CFG));
}
#endif

/**
 * @brief Enable the remapping of TIM1 alternate function channels 1 to 4, 1N to
 * 3N, external trigger (ETR) and Break input (BKIN)
 * @rmtoll MAPR          TIM1_REMAP           LL_GPIO_AF_EnableRemap_TIM1
 * @note  ENABLE: Full remap     (ETR/PE7,  CH1/PE9, CH2/PE11, CH3/PE13,
 * CH4/PE14, BKIN/PE15, CH1N/PE8,  CH2N/PE10, CH3N/PE12)
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM1(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM1_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_TIM1_REMAP_FULLREMAP | AFIO_MAPR_SWJ_CFG));
}
 ...
 * @note  PARTIAL: Partial remap (ETR/PA12, CH1/PA8, CH2/PA9,  CH3/PA10,
 * CH4/PA11, BKIN/PA6,  CH1N/PA7,  CH2N/PB0,  CH3N/PB1)
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_RemapPartial_TIM1(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM1_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_TIM1_REMAP_PARTIALREMAP | AFIO_MAPR_SWJ_CFG));
}

/**
 * @brief Disable the remapping of TIM1 alternate function channels 1 to 4, 1N
 * to 3N, external trigger (ETR) and Break input (BKIN)
 * @rmtoll MAPR          TIM1_REMAP           LL_GPIO_AF_DisableRemap_TIM1
 * @note  DISABLE: No remap      (ETR/PA12, CH1/PA8, CH2/PA9,  CH3/PA10,
 * CH4/PA11, BKIN/PB12, CH1N/PB13, CH2N/PB14, CH3N/PB15)
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM1(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM1_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_TIM1_REMAP_NOREMAP | AFIO_MAPR_SWJ_CFG));
}

/**
 * @brief Enable the remapping of TIM2 alternate function channels 1 to 4 and
...
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM2(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM2_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_TIM2_REMAP_FULLREMAP | AFIO_MAPR_SWJ_CFG));
}
...
__STATIC_INLINE void LL_GPIO_AF_RemapPartial2_TIM2(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM2_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_TIM2_REMAP_PARTIALREMAP2 | AFIO_MAPR_SWJ_CFG));
}
...
__STATIC_INLINE void LL_GPIO_AF_RemapPartial1_TIM2(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM2_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_TIM2_REMAP_PARTIALREMAP1 | AFIO_MAPR_SWJ_CFG));
}

/**
 * @brief Disable the remapping of TIM2 alternate function channels 1 to 4 and
 * external trigger (ETR)
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM2(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM2_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_TIM2_REMAP_NOREMAP | AFIO_MAPR_SWJ_CFG));
}
...
__STATIC_INLINE void LL_GPIO_AF_EnableRemap_TIM3(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM3_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_TIM3_REMAP_FULLREMAP | AFIO_MAPR_SWJ_CFG));
}
...
__STATIC_INLINE void LL_GPIO_AF_RemapPartial_TIM3(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM3_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_TIM3_REMAP_PARTIALREMAP | AFIO_MAPR_SWJ_CFG));
}
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM3(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM3_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_TIM3_REMAP_NOREMAP | AFIO_MAPR_SWJ_CFG));
}
 ...
 * @note  ENABLE: Full remap (TIM4_CH1/PD12, TIM4_CH2/PD13, TIM4_CH3/PD14,
 * TIM4_CH4/PD15)
 ...
 * @note  DISABLE: No remap  (TIM4_CH1/PB6,  TIM4_CH2/PB7,  TIM4_CH3/PB8,
 * TIM4_CH4/PB9)
 * @note  TIM4_ETR on PE0 is not re-mapped.
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM4(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM4_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
...
/**
 * @brief Enable or disable the remapping of CAN alternate function CAN_RX and
 * CAN_TX in devices with a single CAN interface.
...
__STATIC_INLINE void LL_GPIO_AF_RemapPartial1_CAN1(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_CAN_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_CAN_REMAP_REMAP1 | AFIO_MAPR_SWJ_CFG));
}
 ...
 * @note  CASE 2: CAN_RX mapped to PB8,  CAN_TX mapped to PB9 (not available on
 * 36-pin package)
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_RemapPartial2_CAN1(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_CAN_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_CAN_REMAP_REMAP2 | AFIO_MAPR_SWJ_CFG));
}
...
__STATIC_INLINE void LL_GPIO_AF_RemapPartial3_CAN1(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_CAN_REMAP | AFIO_MAPR_SWJ_CFG),
             (AFIO_MAPR_CAN_REMAP_REMAP3 | AFIO_MAPR_SWJ_CFG));
}
#endif

/**
 * @brief Enable the remapping of PD0 and PD1. When the HSE oscillator is not
 * used (application running on internal 8 MHz RC) PD0 and PD1 can be mapped on
 * OSC_IN and OSC_OUT. This is available only on 36, 48 and 64 pins packages
 * (PD0 and PD1 are available on 100-pin and 144-pin packages, no need for
 * remapping).
...
/**
 * @brief Disable the remapping of PD0 and PD1. When the HSE oscillator is not
 * used (application running on internal 8 MHz RC) PD0 and PD1 can be mapped on
 * OSC_IN and OSC_OUT. This is available only on 36, 48 and 64 pins packages
 * (PD0 and PD1 are available on 100-pin and 144-pin packages, no need for
 * remapping).
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_PD01(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_PD01_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
 ...
 * @note  ENABLE: LSI internal clock is connected to TIM5_CH4 input for
 * calibration purpose.
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_TIM5CH4(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM5CH4_IREMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM5CH4(void) {
  return (READ_BIT(AFIO->MAPR, AFIO_MAPR_TIM5CH4_IREMAP) ==
 ...
 * @note  ENABLE: Remap     (RX_DV-CRS_DV/PD8, RXD0/PD9, RXD1/PD10, RXD2/PD11,
 * RXD3/PD12)
 * @note  This bit is available only in connectivity line devices and is
 * reserved otherwise.
 * @retval None
 */
 ...
 * @note  DISABLE: No remap (RX_DV-CRS_DV/PA7, RXD0/PC4, RXD1/PC5,  RXD2/PB0,
 * RXD3/PB1)
 * @note  This bit is available only in connectivity line devices and is
 * reserved otherwise.
 * @retval None
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_ETH(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_ETH_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_CAN2(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_CAN2_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
...
/**
 * @brief Configures the Ethernet MAC internally for use with an external MII or
 * RMII PHY.
...
__STATIC_INLINE void LL_GPIO_AF_Select_ETH_MII(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_MII_RMII_SEL | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
#endif
...
/**
 * @brief Enable the remapping of ADC1_ETRGINJ (ADC 1 External trigger injected
 * conversion).
 * @rmtoll MAPR          ADC1_ETRGINJ_REMAP LL_GPIO_AF_EnableRemap_ADC1_ETRGINJ
 * @note  ENABLE: ADC1 External Event injected conversion is connected to TIM8
 * Channel4.
 * @retval None
 */
...
/**
 * @brief Disable the remapping of ADC1_ETRGINJ (ADC 1 External trigger injected
 * conversion).
 * @rmtoll MAPR          ADC1_ETRGINJ_REMAP LL_GPIO_AF_DisableRemap_ADC1_ETRGINJ
 * @note  DISABLE: ADC1 External trigger injected conversion is connected to
 * EXTI15
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_ADC1_ETRGINJ(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_ADC1_ETRGINJ_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}

/**
 * @brief  Check if ADC1_ETRGINJ has been remapped or not
 * @rmtoll MAPR         ADC1_ETRGINJ_REMAP
 * LL_GPIO_AF_IsEnabledRemap_ADC1_ETRGINJ
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_ADC1_ETRGINJ(void) {
  return (READ_BIT(AFIO->MAPR, AFIO_MAPR_ADC1_ETRGINJ_REMAP) ==
...
/**
 * @brief Enable the remapping of ADC1_ETRGREG (ADC 1 External trigger regular
 * conversion).
 * @rmtoll MAPR          ADC1_ETRGREG_REMAP LL_GPIO_AF_EnableRemap_ADC1_ETRGREG
 * @note  ENABLE: ADC1 External Event regular conversion is connected to TIM8
 * TRG0.
 * @retval None
 */
...
/**
 * @brief Disable the remapping of ADC1_ETRGREG (ADC 1 External trigger regular
 * conversion).
 * @rmtoll MAPR          ADC1_ETRGREG_REMAP LL_GPIO_AF_DisableRemap_ADC1_ETRGREG
 * @note  DISABLE: ADC1 External trigger regular conversion is connected to
 * EXTI11
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_ADC1_ETRGREG(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_ADC1_ETRGREG_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}

/**
 * @brief  Check if ADC1_ETRGREG has been remapped or not
 * @rmtoll MAPR         ADC1_ETRGREG_REMAP
 * LL_GPIO_AF_IsEnabledRemap_ADC1_ETRGREG
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_ADC1_ETRGREG(void) {
  return (READ_BIT(AFIO->MAPR, AFIO_MAPR_ADC1_ETRGREG_REMAP) ==
...
/**
 * @brief Enable the remapping of ADC2_ETRGREG (ADC 2 External trigger injected
 * conversion).
 * @rmtoll MAPR          ADC2_ETRGINJ_REMAP LL_GPIO_AF_EnableRemap_ADC2_ETRGINJ
 * @note  ENABLE: ADC2 External Event injected conversion is connected to TIM8
 * Channel4.
 * @retval None
 */
...
/**
 * @brief Disable the remapping of ADC2_ETRGREG (ADC 2 External trigger injected
 * conversion).
 * @rmtoll MAPR          ADC2_ETRGINJ_REMAP LL_GPIO_AF_DisableRemap_ADC2_ETRGINJ
 * @note  DISABLE: ADC2 External trigger injected conversion is connected to
 * EXTI15
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_ADC2_ETRGINJ(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_ADC2_ETRGINJ_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}

/**
 * @brief  Check if ADC2_ETRGINJ has been remapped or not
 * @rmtoll MAPR         ADC2_ETRGINJ_REMAP
 * LL_GPIO_AF_IsEnabledRemap_ADC2_ETRGINJ
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_ADC2_ETRGINJ(void) {
  return (READ_BIT(AFIO->MAPR, AFIO_MAPR_ADC2_ETRGINJ_REMAP) ==
...
/**
 * @brief Enable the remapping of ADC2_ETRGREG (ADC 2 External trigger regular
 * conversion).
 * @rmtoll MAPR          ADC2_ETRGREG_REMAP LL_GPIO_AF_EnableRemap_ADC2_ETRGREG
 * @note  ENABLE: ADC2 External Event regular conversion is connected to TIM8
 * TRG0.
 * @retval None
 */
...
/**
 * @brief Disable the remapping of ADC2_ETRGREG (ADC 2 External trigger regular
 * conversion).
 * @rmtoll MAPR          ADC2_ETRGREG_REMAP LL_GPIO_AF_DisableRemap_ADC2_ETRGREG
 * @note  DISABLE: ADC2 External trigger regular conversion is connected to
 * EXTI11
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_ADC2_ETRGREG(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_ADC2_ETRGREG_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}

/**
 * @brief  Check if ADC2_ETRGREG has been remapped or not
 * @rmtoll MAPR         ADC2_ETRGREG_REMAP
 * LL_GPIO_AF_IsEnabledRemap_ADC2_ETRGREG
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_ADC2_ETRGREG(void) {
  return (READ_BIT(AFIO->MAPR, AFIO_MAPR_ADC2_ETRGREG_REMAP) ==
...
/**
 * @brief Enable the remapping of SPI3 alternate functions SPI3_NSS/I2S3_WS,
 * SPI3_SCK/I2S3_CK, SPI3_MISO, SPI3_MOSI/I2S3_SD.
 * @rmtoll MAPR          SPI3_REMAP           LL_GPIO_AF_EnableRemap_SPI3
 * @note  ENABLE: Remap     (SPI3_NSS-I2S3_WS/PA4,  SPI3_SCK-I2S3_CK/PC10,
 * SPI3_MISO/PC11, SPI3_MOSI-I2S3_SD/PC12)
 * @note  This bit is available only in connectivity line devices and is
 * reserved otherwise.
 * @retval None
 */
...
/**
 * @brief Disable the remapping of SPI3 alternate functions SPI3_NSS/I2S3_WS,
 * SPI3_SCK/I2S3_CK, SPI3_MISO, SPI3_MOSI/I2S3_SD.
 * @rmtoll MAPR          SPI3_REMAP           LL_GPIO_AF_DisableRemap_SPI3
 * @note  DISABLE: No remap (SPI3_NSS-I2S3_WS/PA15, SPI3_SCK-I2S3_CK/PB3,
 * SPI3_MISO/PB4,  SPI3_MOSI-I2S3_SD/PB5).
 * @note  This bit is available only in connectivity line devices and is
 * reserved otherwise.
 * @retval None
 */
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_SPI3(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_SPI3_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
 ...
 * @note  TO_USB: Connect USB OTG SOF (Start of Frame) output to TIM2_ITR1 for
 ...
 * @note  TO_ETH: Connect TIM2_ITR1 internally to the Ethernet PTP output for
 * calibration purposes.
 * @note  This bit is available only in connectivity line devices and is
 * reserved otherwise.
 * @retval None
...
__STATIC_INLINE void LL_GPIO_AF_Remap_TIM2ITR1_TO_ETH(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_TIM2ITR1_IREMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
#endif
...
__STATIC_INLINE void LL_GPIO_AF_DisableRemap_ETH_PTP_PPS(void) {
  MODIFY_REG(AFIO->MAPR, (AFIO_MAPR_PTP_PPS_REMAP | AFIO_MAPR_SWJ_CFG),
             AFIO_MAPR_SWJ_CFG);
}
#endif
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM9(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM9_REMAP) ==
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM10(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM10_REMAP) ==
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM11(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM11_REMAP) ==
 ...
 * @note  ENABLE: Remap     STM32F100:(TIM13_CH1 on PF8). Others:(TIM13_CH1 on
 * PB0).
 * @retval None
 */
 ...
 * @note  DISABLE: No remap STM32F100:(TIM13_CH1 on PA6). Others:(TIM13_CH1 on
 * PC8).
 * @retval None
 */
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM13(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM13_REMAP) ==
 ...
 * @note  ENABLE: Remap     STM32F100:(TIM14_CH1 on PB1). Others:(TIM14_CH1 on
 * PF9).
 * @retval None
 */
 ...
 * @note  DISABLE: No remap STM32F100:(TIM14_CH1 on PC9). Others:(TIM14_CH1 on
 * PA7).
 * @retval None
 */
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM14(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM14_REMAP) ==
 ...
 * @note  DISCONNECTED: The NADV signal is not connected. The I/O pin can be
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM16(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM16_REMAP) ==
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM17(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM17_REMAP) ==
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_CEC(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_CEC_REMAP) ==
...
/**
 * @brief Controls the mapping of the TIM1_CH1 TIM1_CH2 DMA requests onto the
 * DMA1 channels.
 * @rmtoll MAPR2          TIM1_DMA_REMAP LL_GPIO_AF_EnableRemap_TIM1DMA
 * @note  ENABLE: Remap (TIM1_CH1 DMA request/DMA1 Channel6, TIM1_CH2 DMA
 * request/DMA1 Channel6)
 * @retval None
 */
 ...
 * @note  DISABLE: No remap (TIM1_CH1 DMA request/DMA1 Channel2, TIM1_CH2 DMA
 * request/DMA1 Channel3).
 * @retval None
 */
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM1DMA(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM1_DMA_REMAP) ==
...
/**
 * @brief Controls the mapping of the TIM6_DAC1 and TIM7_DAC2 DMA requests onto
 * the DMA1 channels.
 * @rmtoll MAPR2          TIM76_DAC_DMA_REMAP LL_GPIO_AF_EnableRemap_TIM67DACDMA
 * @note  ENABLE: Remap (TIM6_DAC1 DMA request/DMA1 Channel3, TIM7_DAC2 DMA
 * request/DMA1 Channel4)
 * @retval None
 */
 ...
 * @brief Controls the mapping of the TIM6_DAC1 and TIM7_DAC2 DMA requests onto
 * the DMA1 channels.
 * @rmtoll MAPR2          TIM76_DAC_DMA_REMAP
 * LL_GPIO_AF_DisableRemap_TIM67DACDMA
 * @note  DISABLE: No remap (TIM6_DAC1 DMA request/DMA2 Channel3, TIM7_DAC2 DMA
 * request/DMA2 Channel4)
 * @retval None
 */
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM67DACDMA(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM67_DAC_DMA_REMAP) ==
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_TIM12(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_TIM12_REMAP) ==
 ...
 *        This bit is set and cleared by software. It controls miscellaneous
 * features. The DMA2 channel 5 interrupt position in the vector table. The
 * timer selection for DAC trigger 3 (TSEL[2:0] = 011, for more details refer to
 * the DAC_CR register).
 * @rmtoll MAPR2          MISC_REMAP           LL_GPIO_AF_EnableRemap_MISC
 * @note  ENABLE: DMA2 channel 5 interrupt is mapped separately at position 60
 * and TIM15 TRGO event is selected as DAC Trigger 3, TIM15 triggers TIM1/3.
 * @note  This bit is available only in high density value line devices.
 * @retval None
 */
 ...
 * @note  DISABLE: DMA2 channel 5 interrupt is mapped with DMA2 channel 4 at
 * position 59, TIM5 TRGO event is selected as DAC Trigger 3, TIM5 triggers
 * TIM1/3.
 * @note  This bit is available only in high density value line devices.
 * @retval None
 */
...
__STATIC_INLINE uint32_t LL_GPIO_AF_IsEnabledRemap_MISC(void) {
  return (READ_BIT(AFIO->MAPR2, AFIO_MAPR2_MISC_REMAP) ==
...
/**
 * @brief  Configures the port and pin on which the EVENTOUT Cortex signal will
 * be connected.
...
__STATIC_INLINE void LL_GPIO_AF_ConfigEventout(uint32_t LL_GPIO_PortSource,
  ...
  MODIFY_REG(AFIO->EVCR, (AFIO_EVCR_PORT) | (AFIO_EVCR_PIN),
             (LL_GPIO_PortSource) | (LL_GPIO_PinSource));
}
...
__STATIC_INLINE void LL_GPIO_AF_SetEXTISource(uint32_t Port, uint32_t Line) {
  MODIFY_REG(AFIO->EXTICR[Line & 0xFF], (Line >> 16),
             Port << POSITION_VAL((Line >> 16)));
}
...
__STATIC_INLINE uint32_t LL_GPIO_AF_GetEXTISource(uint32_t Line) {
  return (uint32_t)(READ_BIT(AFIO->EXTICR[Line & 0xFF], (Line >> 16)) >>
                    POSITION_VAL(Line >> 16));
}
