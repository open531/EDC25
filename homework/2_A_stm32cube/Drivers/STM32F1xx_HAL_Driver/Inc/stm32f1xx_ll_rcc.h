...
#define LL_RCC_CIR_PLL3RDYF                                                    \
  RCC_CIR_PLL3RDYF /*!< PLL3(PLLI2S) Ready Interrupt flag */
#define LL_RCC_CIR_PLL2RDYF RCC_CIR_PLL2RDYF /*!< PLL2 Ready Interrupt flag */
#define LL_RCC_CIR_CSSF                                                        \
 ...
 * @{
 */
#define LL_RCC_HSE_PREDIV2_DIV_1                                               \
  RCC_CFGR2_PREDIV2_DIV1 /*!< PREDIV2 input clock not divided */
#define LL_RCC_HSE_PREDIV2_DIV_2                                               \
  RCC_CFGR2_PREDIV2_DIV2 /*!< PREDIV2 input clock divided by 2 */
#define LL_RCC_HSE_PREDIV2_DIV_3                                               \
  RCC_CFGR2_PREDIV2_DIV3 /*!< PREDIV2 input clock divided by 3 */
#define LL_RCC_HSE_PREDIV2_DIV_4                                               \
  RCC_CFGR2_PREDIV2_DIV4 /*!< PREDIV2 input clock divided by 4 */
#define LL_RCC_HSE_PREDIV2_DIV_5                                               \
  RCC_CFGR2_PREDIV2_DIV5 /*!< PREDIV2 input clock divided by 5 */
#define LL_RCC_HSE_PREDIV2_DIV_6                                               \
  RCC_CFGR2_PREDIV2_DIV6 /*!< PREDIV2 input clock divided by 6 */
#define LL_RCC_HSE_PREDIV2_DIV_7                                               \
  RCC_CFGR2_PREDIV2_DIV7 /*!< PREDIV2 input clock divided by 7 */
#define LL_RCC_HSE_PREDIV2_DIV_8                                               \
  RCC_CFGR2_PREDIV2_DIV8 /*!< PREDIV2 input clock divided by 8 */
#define LL_RCC_HSE_PREDIV2_DIV_9                                               \
  RCC_CFGR2_PREDIV2_DIV9 /*!< PREDIV2 input clock divided by 9 */
#define LL_RCC_HSE_PREDIV2_DIV_10                                              \
  RCC_CFGR2_PREDIV2_DIV10 /*!< PREDIV2 input clock divided by 10 */
#define LL_RCC_HSE_PREDIV2_DIV_11                                              \
  RCC_CFGR2_PREDIV2_DIV11 /*!< PREDIV2 input clock divided by 11 */
#define LL_RCC_HSE_PREDIV2_DIV_12                                              \
  RCC_CFGR2_PREDIV2_DIV12 /*!< PREDIV2 input clock divided by 12 */
#define LL_RCC_HSE_PREDIV2_DIV_13                                              \
  RCC_CFGR2_PREDIV2_DIV13 /*!< PREDIV2 input clock divided by 13 */
#define LL_RCC_HSE_PREDIV2_DIV_14                                              \
  RCC_CFGR2_PREDIV2_DIV14 /*!< PREDIV2 input clock divided by 14 */
#define LL_RCC_HSE_PREDIV2_DIV_15                                              \
  RCC_CFGR2_PREDIV2_DIV15 /*!< PREDIV2 input clock divided by 15 */
#define LL_RCC_HSE_PREDIV2_DIV_16                                              \
  RCC_CFGR2_PREDIV2_DIV16 /*!< PREDIV2 input clock divided by 16 */
/**
 * @}
 */
...
#define LL_RCC_MCO1SOURCE_NOCLOCK                                              \
  RCC_CFGR_MCO_NOCLOCK /*!< MCO output disabled, no clock on MCO */
#define LL_RCC_MCO1SOURCE_SYSCLK                                               \
  RCC_CFGR_MCO_SYSCLK /*!< SYSCLK selection as MCO source */
#define LL_RCC_MCO1SOURCE_HSI                                                  \
  RCC_CFGR_MCO_HSI /*!< HSI selection as MCO source */
#define LL_RCC_MCO1SOURCE_HSE                                                  \
  RCC_CFGR_MCO_HSE /*!< HSE selection as MCO source */
#define LL_RCC_MCO1SOURCE_PLLCLK_DIV_2                                         \
  RCC_CFGR_MCO_PLLCLK_DIV2 /*!< PLL clock divided by 2*/
#if defined(RCC_CFGR_MCO_PLL2CLK)
#define LL_RCC_MCO1SOURCE_PLL2CLK                                              \
  RCC_CFGR_MCO_PLL2CLK /*!< PLL2 clock selected as MCO source*/
#endif                 /* RCC_CFGR_MCO_PLL2CLK */
#if defined(RCC_CFGR_MCO_PLL3CLK_DIV2)
#define LL_RCC_MCO1SOURCE_PLLI2SCLK_DIV2                                       \
  RCC_CFGR_MCO_PLL3CLK_DIV2 /*!< PLLI2S clock divided by 2 selected as MCO     \
                               source*/
#endif                      /* RCC_CFGR_MCO_PLL3CLK_DIV2 */
#if defined(RCC_CFGR_MCO_EXT_HSE)
#define LL_RCC_MCO1SOURCE_EXT_HSE                                              \
  RCC_CFGR_MCO_EXT_HSE /*!< XT1 external 3-25 MHz oscillator clock selected as \
                          MCO source */
#endif                 /* RCC_CFGR_MCO_EXT_HSE */
#if defined(RCC_CFGR_MCO_PLL3CLK)
#define LL_RCC_MCO1SOURCE_PLLI2SCLK                                            \
  RCC_CFGR_MCO_PLL3CLK /*!< PLLI2S clock selected as MCO source */
 ...
 * @{
 */
#define LL_RCC_I2S2_CLKSOURCE_SYSCLK                                           \
  RCC_CFGR2_I2S2SRC /*!< System clock (SYSCLK) selected as I2S2 clock entry */
#define LL_RCC_I2S2_CLKSOURCE_PLLI2S_VCO                                       \
  (uint32_t)(RCC_CFGR2_I2S2SRC |                                               \
             (RCC_CFGR2_I2S2SRC >>                                             \
              16U)) /*!< PLLI2S VCO clock selected as I2S2 clock entry */
#define LL_RCC_I2S3_CLKSOURCE_SYSCLK                                           \
  RCC_CFGR2_I2S3SRC /*!< System clock (SYSCLK) selected as I2S3 clock entry */
#define LL_RCC_I2S3_CLKSOURCE_PLLI2S_VCO                                       \
  (uint32_t)(RCC_CFGR2_I2S3SRC |                                               \
             (RCC_CFGR2_I2S3SRC >>                                             \
              16U)) /*!< PLLI2S VCO clock selected as I2S3 clock entry */
/**
 * @}
 */
...
#define LL_RCC_USB_CLKSOURCE_PLL                                               \
  RCC_CFGR_USBPRE /*!< PLL clock is not divided */
#define LL_RCC_USB_CLKSOURCE_PLL_DIV_1_5                                       \
  0x00000000U /*!< PLL clock is divided by 1.5 */
#endif        /*RCC_CFGR_USBPRE*/
#if defined(RCC_CFGR_OTGFSPRE)
#define LL_RCC_USB_CLKSOURCE_PLL_DIV_2                                         \
  RCC_CFGR_OTGFSPRE /*!< PLL clock is divided by 2 */
#define LL_RCC_USB_CLKSOURCE_PLL_DIV_3                                         \
  0x00000000U /*!< PLL clock is divided by 3 */
...
/** @defgroup RCC_LL_EC_ADC_CLKSOURCE_PCLK2 Peripheral ADC clock source
 * selection
 * @{
 */
#define LL_RCC_ADC_CLKSRC_PCLK2_DIV_2                                          \
  RCC_CFGR_ADCPRE_DIV2 /*ADC prescaler PCLK2 divided by 2*/
#define LL_RCC_ADC_CLKSRC_PCLK2_DIV_4                                          \
  RCC_CFGR_ADCPRE_DIV4 /*ADC prescaler PCLK2 divided by 4*/
#define LL_RCC_ADC_CLKSRC_PCLK2_DIV_6                                          \
  RCC_CFGR_ADCPRE_DIV6 /*ADC prescaler PCLK2 divided by 6*/
#define LL_RCC_ADC_CLKSRC_PCLK2_DIV_8                                          \
  RCC_CFGR_ADCPRE_DIV8 /*ADC prescaler PCLK2 divided by 8*/
/**
 * @}
 */
 ...
 * @{
 */
#define LL_RCC_I2S2_CLKSOURCE                                                  \
  RCC_CFGR2_I2S2SRC /*!< I2S2 Clock source selection */
#define LL_RCC_I2S3_CLKSOURCE                                                  \
  RCC_CFGR2_I2S3SRC /*!< I2S3 Clock source selection */
/**
 * @}
 */
...
#define LL_RCC_RTC_CLKSOURCE_HSE_DIV128                                        \
  RCC_BDCR_RTCSEL /*!< HSE oscillator clock divided by 128 used as RTC clock   \
                   */
/**
 * @}
 */
...
#define LL_RCC_PLLSOURCE_HSE                                                   \
  RCC_CFGR_PLLSRC /*!< HSE/PREDIV1 clock selected as PLL entry clock source */
#if defined(RCC_CFGR2_PREDIV1SRC)
#define LL_RCC_PLLSOURCE_PLL2                                                  \
  (RCC_CFGR_PLLSRC |                                                           \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/PREDIV1 clock selected as PLL entry clock source */
#endif        /*RCC_CFGR2_PREDIV1SRC*/

#if defined(RCC_CFGR2_PREDIV1)
#define LL_RCC_PLLSOURCE_HSE_DIV_1                                             \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV1) /*!< HSE/1 clock selected as PLL  \
                                                entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_2                                             \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV2) /*!< HSE/2 clock selected as PLL  \
                                                entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_3                                             \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV3) /*!< HSE/3 clock selected as PLL  \
                                                entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_4                                             \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV4) /*!< HSE/4 clock selected as PLL  \
                                                entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_5                                             \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV5) /*!< HSE/5 clock selected as PLL  \
                                                entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_6                                             \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV6) /*!< HSE/6 clock selected as PLL  \
                                                entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_7                                             \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV7) /*!< HSE/7 clock selected as PLL  \
                                                entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_8                                             \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV8) /*!< HSE/8 clock selected as PLL  \
                                                entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_9                                             \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV9) /*!< HSE/9 clock selected as PLL  \
                                                entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_10                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV10) /*!< HSE/10 clock selected as    \
                                                 PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_11                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV11) /*!< HSE/11 clock selected as    \
                                                 PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_12                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV12) /*!< HSE/12 clock selected as    \
                                                 PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_13                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV13) /*!< HSE/13 clock selected as    \
                                                 PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_14                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV14) /*!< HSE/14 clock selected as    \
                                                 PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_15                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV15) /*!< HSE/15 clock selected as    \
                                                 PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_16                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV16) /*!< HSE/16 clock selected as    \
                                                 PLL entry clock source */
#if defined(RCC_CFGR2_PREDIV1SRC)
#define LL_RCC_PLLSOURCE_PLL2_DIV_1                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV1 |                                  \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/1 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_2                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV2 |                                  \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/2 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_3                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV3 |                                  \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/3 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_4                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV4 |                                  \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/4 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_5                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV5 |                                  \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/5 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_6                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV6 |                                  \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/6 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_7                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV7 |                                  \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/7 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_8                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV8 |                                  \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/8 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_9                                            \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV9 |                                  \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/9 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_10                                           \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV10 |                                 \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/10 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_11                                           \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV11 |                                 \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/11 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_12                                           \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV12 |                                 \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/12 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_13                                           \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV13 |                                 \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/13 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_14                                           \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV14 |                                 \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/14 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_15                                           \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV15 |                                 \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/15 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_PLL2_DIV_16                                           \
  (RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV16 |                                 \
   RCC_CFGR2_PREDIV1SRC                                                        \
       << 4U) /*!< PLL2/16 clock selected as PLL entry clock source */
#endif        /*RCC_CFGR2_PREDIV1SRC*/
#else
#define LL_RCC_PLLSOURCE_HSE_DIV_1                                             \
  (RCC_CFGR_PLLSRC |                                                           \
   0x00000000U) /*!< HSE/1 clock selected as PLL entry clock source */
#define LL_RCC_PLLSOURCE_HSE_DIV_2                                             \
  (RCC_CFGR_PLLSRC |                                                           \
   RCC_CFGR_PLLXTPRE) /*!< HSE/2 clock selected as PLL entry clock source */
 ...
 */
#if defined(RCC_CFGR2_PREDIV1)
#define LL_RCC_PREDIV_DIV_1                                                    \
  RCC_CFGR2_PREDIV1_DIV1 /*!< PREDIV1 input clock not divided */
#define LL_RCC_PREDIV_DIV_2                                                    \
  RCC_CFGR2_PREDIV1_DIV2 /*!< PREDIV1 input clock divided by 2 */
#define LL_RCC_PREDIV_DIV_3                                                    \
  RCC_CFGR2_PREDIV1_DIV3 /*!< PREDIV1 input clock divided by 3 */
#define LL_RCC_PREDIV_DIV_4                                                    \
  RCC_CFGR2_PREDIV1_DIV4 /*!< PREDIV1 input clock divided by 4 */
#define LL_RCC_PREDIV_DIV_5                                                    \
  RCC_CFGR2_PREDIV1_DIV5 /*!< PREDIV1 input clock divided by 5 */
#define LL_RCC_PREDIV_DIV_6                                                    \
  RCC_CFGR2_PREDIV1_DIV6 /*!< PREDIV1 input clock divided by 6 */
#define LL_RCC_PREDIV_DIV_7                                                    \
  RCC_CFGR2_PREDIV1_DIV7 /*!< PREDIV1 input clock divided by 7 */
#define LL_RCC_PREDIV_DIV_8                                                    \
  RCC_CFGR2_PREDIV1_DIV8 /*!< PREDIV1 input clock divided by 8 */
#define LL_RCC_PREDIV_DIV_9                                                    \
  RCC_CFGR2_PREDIV1_DIV9 /*!< PREDIV1 input clock divided by 9 */
#define LL_RCC_PREDIV_DIV_10                                                   \
  RCC_CFGR2_PREDIV1_DIV10 /*!< PREDIV1 input clock divided by 10 */
#define LL_RCC_PREDIV_DIV_11                                                   \
  RCC_CFGR2_PREDIV1_DIV11 /*!< PREDIV1 input clock divided by 11 */
#define LL_RCC_PREDIV_DIV_12                                                   \
  RCC_CFGR2_PREDIV1_DIV12 /*!< PREDIV1 input clock divided by 12 */
#define LL_RCC_PREDIV_DIV_13                                                   \
  RCC_CFGR2_PREDIV1_DIV13 /*!< PREDIV1 input clock divided by 13 */
#define LL_RCC_PREDIV_DIV_14                                                   \
  RCC_CFGR2_PREDIV1_DIV14 /*!< PREDIV1 input clock divided by 14 */
#define LL_RCC_PREDIV_DIV_15                                                   \
  RCC_CFGR2_PREDIV1_DIV15 /*!< PREDIV1 input clock divided by 15 */
#define LL_RCC_PREDIV_DIV_16                                                   \
  RCC_CFGR2_PREDIV1_DIV16 /*!< PREDIV1 input clock divided by 16 */
#else
#define LL_RCC_PREDIV_DIV_1                                                    \
  0x00000000U /*!< HSE divider clock clock not divided */
#define LL_RCC_PREDIV_DIV_2                                                    \
  RCC_CFGR_PLLXTPRE /*!< HSE divider clock divided by 2 for PLL entry */
#endif              /*RCC_CFGR2_PREDIV1*/
/**
 * @}
 */
 ...
 * LL_RCC_PLL_GetPrediv () + 1), @ref LL_RCC_PLL_GetMultiplicator());
 * @param  __INPUTFREQ__ PLL Input frequency (based on HSE div Prediv1 / HSI div
 * 2 / PLL2 div Prediv1)
...
#define __LL_RCC_CALC_PLLCLK_FREQ(__INPUTFREQ__, __PLLMUL__)                   \
  (((__PLLMUL__) != RCC_CFGR_PLLMULL6_5)                                       \
       ? ((__INPUTFREQ__) *                                                    \
          ((((__PLLMUL__)&RCC_CFGR_PLLMULL) >> RCC_CFGR_PLLMULL_Pos) + 2U))    \
 ...
 * @note ex: @ref __LL_RCC_CALC_PLLCLK_FREQ (HSE_VALUE / (@ref
 * LL_RCC_PLL_GetPrediv () + 1), @ref LL_RCC_PLL_GetMultiplicator ());
 * @param  __INPUTFREQ__ PLL Input frequency (based on HSE div Prediv1 or div 2
 * / HSI div 2)
 * @param  __PLLMUL__: This parameter can be one of the following values:
 ...
 * @note ex: @ref __LL_RCC_CALC_PLLI2SCLK_FREQ (HSE_VALUE, @ref
 * LL_RCC_PLLI2S_GetMultiplicator (), @ref LL_RCC_HSE_GetPrediv2 ());
 ...
 */
#define __LL_RCC_CALC_PLLI2SCLK_FREQ(__INPUTFREQ__, __PLLI2SMUL__,             \
                                     __PLLI2SDIV__)                            \
  (((__INPUTFREQ__) * (((__PLLI2SMUL__) >> RCC_CFGR2_PLL3MUL_Pos) + 2U)) /     \
   (((__PLLI2SDIV__) >> RCC_CFGR2_PREDIV2_Pos) + 1U))
#endif /* RCC_PLLI2S_SUPPORT */

#if defined(RCC_PLL2_SUPPORT)
/**
 * @brief  Helper macro to calculate the PLL2 frequency
 * @note ex: @ref __LL_RCC_CALC_PLL2CLK_FREQ (HSE_VALUE, @ref
 * LL_RCC_PLL2_GetMultiplicator (), @ref LL_RCC_HSE_GetPrediv2 ());
 ...
 */
#define __LL_RCC_CALC_PLL2CLK_FREQ(__INPUTFREQ__, __PLL2MUL__, __PLL2DIV__)    \
  (((__INPUTFREQ__) * (((__PLL2MUL__) >> RCC_CFGR2_PLL2MUL_Pos) + 2U)) /       \
   (((__PLL2DIV__) >> RCC_CFGR2_PREDIV2_Pos) + 1U))
#endif /* RCC_PLL2_SUPPORT */
 ...
 * @note Once the RTC clock source has been selected, it cannot be changed any
 * more unless the Backup domain is reset. The BDRST bit can be used to reset
 * them.
...
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_SYS(uint32_t Source,
  ...
  MODIFY_REG(RCC->CFGR2, (RCC_CFGR2_PREDIV1 | RCC_CFGR2_PREDIV1SRC),
             (Source & RCC_CFGR2_PREDIV1) |
                 ((Source & (RCC_CFGR2_PREDIV1SRC << 4U)) >> 4U));
#else
...
#if defined(RCC_CFGR2_PREDIV1SRC)
  MODIFY_REG(RCC->CFGR2, RCC_CFGR2_PREDIV1SRC,
             ((PLLSource & (RCC_CFGR2_PREDIV1SRC << 4U)) >> 4U));
#endif /* RCC_CFGR2_PREDIV1SRC */
...
__STATIC_INLINE uint32_t LL_RCC_PLL_GetMainSource(void) {
  ...
  uint32_t predivsrc =
      (uint32_t)(READ_BIT(RCC->CFGR2, RCC_CFGR2_PREDIV1SRC) << 4U);
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_PLLI2S(uint32_t Divider,
                                                    uint32_t Multiplicator) {
  MODIFY_REG(RCC->CFGR2, RCC_CFGR2_PREDIV2 | RCC_CFGR2_PLL3MUL,
             Divider | Multiplicator);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_PLL2(uint32_t Divider,
                                                  uint32_t Multiplicator) {
  MODIFY_REG(RCC->CFGR2, RCC_CFGR2_PREDIV2 | RCC_CFGR2_PLL2MUL,
             Divider | Multiplicator);
}
