...
#define DMA_MINC_ENABLE                                                        \
  ((uint32_t)DMA_CCR_MINC)           /*!< Memory increment mode Enable  */
...
#define DMA_CIRCULAR                                                           \
  ((uint32_t)DMA_CCR_CIRC) /*!< Circular mode                */
/**
 * @}
 */
...
#define DMA_PRIORITY_MEDIUM                                                    \
  ((uint32_t)DMA_CCR_PL_0) /*!< Priority level : Medium    */
#define DMA_PRIORITY_HIGH                                                      \
  ((uint32_t)DMA_CCR_PL_1) /*!< Priority level : High      */
#define DMA_PRIORITY_VERY_HIGH                                                 \
  ((uint32_t)DMA_CCR_PL) /*!< Priority level : Very_High */
/**
 * @}
 */
...
#define __HAL_DMA_ENABLE(__HANDLE__)                                           \
  (SET_BIT((__HANDLE__)->Instance->CCR, DMA_CCR_EN))
...
#define __HAL_DMA_DISABLE(__HANDLE__)                                          \
  (CLEAR_BIT((__HANDLE__)->Instance->CCR, DMA_CCR_EN))
...
#define __HAL_DMA_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)                     \
  ((((__HANDLE__)->Instance->CCR & (__INTERRUPT__)) == (__INTERRUPT__))        \
       ? SET                                                                   \
       : RESET)
