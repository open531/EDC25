...
#define EXTI_LINE_16                                                           \
  (EXTI_CONFIG |                                                               \
   0x10u) /*!< External interrupt line 16 Connected to the PVD Output */
#define EXTI_LINE_17                                                           \
  (EXTI_CONFIG |                                                               \
   0x11u) /*!< External interrupt line 17 Connected to the RTC Alarm event */
#if defined(EXTI_IMR_IM18)
#define EXTI_LINE_18                                                           \
  (EXTI_CONFIG | 0x12u) /*!< External interrupt line 18 Connected to the USB   \
                           Wakeup from suspend event */
#endif                  /* EXTI_IMR_IM18 */
#if defined(EXTI_IMR_IM19)
#define EXTI_LINE_19                                                           \
  (EXTI_CONFIG | 0x13u) /*!< External interrupt line 19 Connected to the       \
