/**
  ...
  *
  ...
  HAL_NVIC_SetPriorityGrouping() function according to the following table.
    (#) Configure the priority of the selected IRQ Channels using
  HAL_NVIC_SetPriority().
    (#) Enable the selected IRQ Channels using HAL_NVIC_EnableIRQ().
    (#) please refer to programming manual for details in how to configure
  priority.

     -@- When the NVIC_PRIORITYGROUP_0 is selected, IRQ preemption is no more
  ...
  macro is defined inside the stm32f1xx_hal_cortex.h file.
...
/** @defgroup CORTEX_Exported_Functions_Group1 Initialization and
 ...
 * the appropriate CMSIS device file (stm32f10xx.h))
 ...
 *         This parameter can be an enumerator of IRQn_Type enumeration
 *         (For the complete STM32 Devices IRQ Channels list, please refer to
 * the appropriate CMSIS device file (stm32f10xxx.h))
 * @retval None
 */
...
/**
 * @brief  Initializes the System Timer and its interrupt, and starts the System
