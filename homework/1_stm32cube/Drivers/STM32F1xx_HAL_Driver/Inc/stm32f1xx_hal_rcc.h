...
#define RCC_PLLSOURCE_HSE                                                      \
  RCC_CFGR_PLLSRC /*!< HSE clock selected as PLL entry clock source */
...
#define RCC_HSICALIBRATION_DEFAULT                                             \
  0x10U /* Default HSI calibration trimming value */
...
#define RCC_RTCCLKSOURCE_HSE_DIV128                                            \
  RCC_BDCR_RTCSEL_HSE /*!< HSE oscillator clock divided by 128 used as RTC     \
                         clock */
/**
 * @}
 */
...
#define RCC_IT_LSIRDY                                                          \
  ((uint8_t)RCC_CIR_LSIRDYF) /*!< LSI Ready Interrupt flag */
#define RCC_IT_LSERDY                                                          \
  ((uint8_t)RCC_CIR_LSERDYF) /*!< LSE Ready Interrupt flag */
#define RCC_IT_HSIRDY                                                          \
  ((uint8_t)RCC_CIR_HSIRDYF) /*!< HSI Ready Interrupt flag */
#define RCC_IT_HSERDY                                                          \
  ((uint8_t)RCC_CIR_HSERDYF) /*!< HSE Ready Interrupt flag */
#define RCC_IT_PLLRDY                                                          \
  ((uint8_t)RCC_CIR_PLLRDYF) /*!< PLL Ready Interrupt flag */
#define RCC_IT_CSS                                                             \
  ((uint8_t)RCC_CIR_CSSF) /*!< Clock Security System Interrupt flag */
/**
 * @}
 */
...
#define RCC_FLAG_HSIRDY                                                        \
  ((uint8_t)((CR_REG_INDEX << 5U) |                                            \
             RCC_CR_HSIRDY_Pos)) /*!< Internal High Speed clock ready flag */
#define RCC_FLAG_HSERDY                                                        \
  ((uint8_t)((CR_REG_INDEX << 5U) |                                            \
             RCC_CR_HSERDY_Pos)) /*!< External High Speed clock ready flag */
#define RCC_FLAG_PLLRDY                                                        \
  ((uint8_t)((CR_REG_INDEX << 5U) |                                            \
             RCC_CR_PLLRDY_Pos)) /*!< PLL clock ready flag */

/* Flags in the CSR register */
#define RCC_FLAG_LSIRDY                                                        \
  ((uint8_t)((CSR_REG_INDEX << 5U) |                                           \
             RCC_CSR_LSIRDY_Pos)) /*!< Internal Low Speed oscillator Ready */
#define RCC_FLAG_PINRST                                                        \
  ((uint8_t)((CSR_REG_INDEX << 5U) |                                           \
             RCC_CSR_PINRSTF_Pos)) /*!< PIN reset flag */
#define RCC_FLAG_PORRST                                                        \
  ((uint8_t)((CSR_REG_INDEX << 5U) |                                           \
             RCC_CSR_PORRSTF_Pos)) /*!< POR/PDR reset flag */
...
#define RCC_FLAG_LSERDY                                                        \
  ((uint8_t)((BDCR_REG_INDEX << 5U) |                                          \
             RCC_BDCR_LSERDY_Pos)) /*!< External Low Speed oscillator Ready */
...
/** @defgroup RCC_Peripheral_Clock_Enable_Disable Peripheral Clock Enable
 * Disable
...
/** @defgroup RCC_AHB_Peripheral_Clock_Enable_Disable_Status AHB Peripheral
...
#define __HAL_RCC_DMA1_IS_CLK_ENABLED()                                        \
  ((RCC->AHBENR & (RCC_AHBENR_DMA1EN)) != RESET)
#define __HAL_RCC_DMA1_IS_CLK_DISABLED()                                       \
  ((RCC->AHBENR & (RCC_AHBENR_DMA1EN)) == RESET)
#define __HAL_RCC_SRAM_IS_CLK_ENABLED()                                        \
  ((RCC->AHBENR & (RCC_AHBENR_SRAMEN)) != RESET)
#define __HAL_RCC_SRAM_IS_CLK_DISABLED()                                       \
  ((RCC->AHBENR & (RCC_AHBENR_SRAMEN)) == RESET)
#define __HAL_RCC_FLITF_IS_CLK_ENABLED()                                       \
  ((RCC->AHBENR & (RCC_AHBENR_FLITFEN)) != RESET)
#define __HAL_RCC_FLITF_IS_CLK_DISABLED()                                      \
  ((RCC->AHBENR & (RCC_AHBENR_FLITFEN)) == RESET)
#define __HAL_RCC_CRC_IS_CLK_ENABLED()                                         \
  ((RCC->AHBENR & (RCC_AHBENR_CRCEN)) != RESET)
...
/** @defgroup RCC_APB1_Peripheral_Clock_Enable_Disable_Status APB1 Peripheral
 * Clock Enable Disable Status
...
#define __HAL_RCC_I2C1_IS_CLK_DISABLED()                                       \
  ((RCC->APB1ENR & (RCC_APB1ENR_I2C1EN)) == RESET)
#define __HAL_RCC_BKP_IS_CLK_ENABLED()                                         \
  ((RCC->APB1ENR & (RCC_APB1ENR_BKPEN)) != RESET)
#define __HAL_RCC_BKP_IS_CLK_DISABLED()                                        \
  ((RCC->APB1ENR & (RCC_APB1ENR_BKPEN)) == RESET)
...
/** @defgroup RCC_APB2_Peripheral_Clock_Enable_Disable_Status APB2 Peripheral
 * Clock Enable Disable Status
...
#define __HAL_RCC_AFIO_RELEASE_RESET()                                         \
...
#define __HAL_RCC_ADC1_RELEASE_RESET()                                         \
...
/** @brief  Macros to enable or disable the Internal High Speed oscillator
 * (HSI).
...
/** @brief  Macro to adjust the Internal High Speed oscillator (HSI) calibration
 * value.
...
#define __HAL_RCC_HSI_CALIBRATIONVALUE_ADJUST(_HSICALIBRATIONVALUE_)           \
  (MODIFY_REG(RCC->CR, RCC_CR_HSITRIM,                                         \
              (uint32_t)(_HSICALIBRATIONVALUE_) << RCC_CR_HSITRIM_Pos))
...
/** @brief Macro to configure the main PLL clock source and multiplication
  factors.
  * @note   This function must be used only when the main PLL is disabled.
  *
  * @param  __RCC_PLLSOURCE__ specifies the PLL entry clock source.
  *          This parameter can be one of the following values:
  *            @arg @ref RCC_PLLSOURCE_HSI_DIV2 HSI oscillator clock selected as
  PLL clock entry
  *            @arg @ref RCC_PLLSOURCE_HSE HSE oscillator clock selected as PLL
  clock entry
  * @param  __PLLMUL__ specifies the multiplication factor for PLL VCO output
  clock
  *          This parameter can be one of the following values:
...
#define __HAL_RCC_GET_PLL_OSCSOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->CFGR, RCC_CFGR_PLLSRC)))
 ...
 *          This parameter can be one of the following values:
 *              @arg @ref RCC_SYSCLKSOURCE_HSI HSI oscillator is used as system
 * clock source.
 *              @arg @ref RCC_SYSCLKSOURCE_HSE HSE oscillator is used as system
 * clock source.
 *              @arg @ref RCC_SYSCLKSOURCE_PLLCLK PLL output is used as system
 * clock source.
 */
...
#define __HAL_RCC_GET_SYSCLK_SOURCE()                                          \
  ((uint32_t)(READ_BIT(RCC->CFGR, RCC_CFGR_SWS)))
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_MCO1SOURCE_NOCLOCK      No clock selected as MCO
 * clock
 *            @arg @ref RCC_MCO1SOURCE_SYSCLK       System clock (SYSCLK)
 * selected as MCO clock
 *            @arg @ref RCC_MCO1SOURCE_HSI          HSI selected as MCO clock
 *            @arg @ref RCC_MCO1SOURCE_HSE          HSE selected as MCO clock
 *            @arg @ref RCC_MCO1SOURCE_PLLCLK       PLL clock divided by 2
 * selected as MCO clock
 *            @arg @ref RCC_MCO1SOURCE_PLL2CLK      PLL2 clock selected by 2
 * selected as MCO clock
 *            @arg @ref RCC_MCO1SOURCE_PLL3CLK_DIV2 PLL3 clock divided by 2
 * selected as MCO clock
 *            @arg @ref RCC_MCO1SOURCE_EXT_HSE XT1  external 3-25 MHz oscillator
 * clock selected (for Ethernet) as MCO clock
 *            @arg @ref RCC_MCO1SOURCE_PLL3CLK      PLL3 clock selected (for
 * Ethernet) as MCO clock
 ...
 *            @arg @ref RCC_MCO1SOURCE_SYSCLK  System clock (SYSCLK) selected as
 * MCO clock
 *            @arg @ref RCC_MCO1SOURCE_HSI HSI selected as MCO clock
 *            @arg @ref RCC_MCO1SOURCE_HSE HSE selected as MCO clock
 *            @arg @ref RCC_MCO1SOURCE_PLLCLK  PLL clock divided by 2 selected
 * as MCO clock
 * @param  __MCODIV__ specifies the MCO clock prescaler.
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_MCODIV_1 No division applied on MCO clock source
 ...
 *         Backup domain is reset using @ref __HAL_RCC_BACKUPRESET_FORCE()
 ...
 *             @arg @ref RCC_RTCCLKSOURCE_HSE_DIV128 HSE divided by 128 selected
 * as RTC clock
 ...
 * @note   These macros must be used only after the RTC clock source was
 * selected.
 */
 ...
 * registers) and the RTC clock source selection in RCC_BDCR register.
 */
#define __HAL_RCC_BACKUPRESET_FORCE()                                          \
  (*(__IO uint32_t *)RCC_BDCR_BDRST_BB = ENABLE)

/** @brief  Macros to release the Backup domain reset.
 */
#define __HAL_RCC_BACKUPRESET_RELEASE()                                        \
  (*(__IO uint32_t *)RCC_BDCR_BDRST_BB = DISABLE)
...
#define __HAL_RCC_GET_IT(__INTERRUPT__)                                        \
  ((RCC->CIR & (__INTERRUPT__)) == (__INTERRUPT__))
...
#define __HAL_RCC_CLEAR_RESET_FLAGS()                                          \
  (*(__IO uint32_t *)RCC_CSR_RMVF_BB = ENABLE)
...
#define __HAL_RCC_GET_FLAG(__FLAG__)                                           \
  (((((__FLAG__) >> 5U) == CR_REG_INDEX)                                       \
        ? RCC->CR                                                              \
        : ((((__FLAG__) >> 5U) == BDCR_REG_INDEX) ? RCC->BDCR : RCC->CSR)) &   \
